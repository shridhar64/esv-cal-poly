...
MODEL              = RUNRUNRUN
MODULES            = RUNRUNRUN_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = RUNRUNRUN.mk
MATLAB_ROOT        = C:\MATLABr2010b
ALT_MATLAB_ROOT    = C:\MATLAB~1
MATLAB_BIN         = C:\MATLABr2010b\bin
ALT_MATLAB_BIN     = C:\MATLAB~1\bin
MASTER_ANCHOR_DIR  = 
START_DIR          = T:\woods\Morecompletestuff3
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 3
...
SHARED_BIN_DIR     = 
SHARED_LIB         = 
MEX_OPT_FILE       = -f "$(MATLAB_BIN)\win64\mexopts\msvc80opts.bat"
COMPUTER           = PCWIN64
VISUAL_VER         = 8.0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\accel\RUNRUNRUN
