...
#include "DVM_Nikola_test_3_sfun.h"
#include "c1_DVM_Nikola_test_3.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "DVM_Nikola_test_3_sfun_debug_macros.h"
...
static const char *c1_debug_family_names[166] = { "g", "v_x", "v_y", "phi",
  ...
  "sigTz", "Am", "Bm", "Cm", "Dm1", "Dm2", "Mass_Matrix", "A1", "B1", "C1", "C2",
  "D1", "D2", "F_c", "F_u", "a_x_new", "a_y_new", "phi_dd_new", "psi_dd_new",
  "nargin", "nargout", "p", "steer", "torque", "acc_in", "pdot", "slp_ang",
  "acc_out", "Fout" };

/* Function Declarations */
static void initialize_c1_DVM_Nikola_test_3(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void initialize_params_c1_DVM_Nikola_test_3
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void enable_c1_DVM_Nikola_test_3(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void disable_c1_DVM_Nikola_test_3(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_DVM_Nikola_test_3
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DVM_Nikola_test_3
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void set_sim_state_c1_DVM_Nikola_test_3
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_DVM_Nikola_test_3(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void sf_c1_DVM_Nikola_test_3(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void c1_c1_DVM_Nikola_test_3(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c1_DVM_Nikola_test_3
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static real_T c1_mpower(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  real_T c1_a);
static real_T c1_power(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  real_T c1_a, real_T c1_b);
static void c1_eml_scalar_eg(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void c1_eml_error(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void c1_eml_xgemm(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  real_T c1_A[9], real_T c1_B[9], real_T c1_C[9], real_T c1_b_C[9]);
static void c1_b_mpower(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  real_T c1_a[16], real_T c1_c[16]);
static void c1_matrix_to_integer_power(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, real_T c1_a[16], real_T c1_b, real_T c1_c[16]);
static void c1_c_eml_scalar_eg(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void c1_d_eml_scalar_eg(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
static void c1_invNxN(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
                      real_T c1_x[16], real_T c1_y[16]);
static void c1_eps(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4],
  int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0);
static int32_T c1_ceval_ixamax(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx);
static void c1_ceval_xswap(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx, int32_T c1_iy0,
  int32_T c1_incy, real_T c1_b_x[16]);
static void c1_ceval_xger(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
...
static void c1_eml_blas_xtrsm(SFc1_DVM_Nikola_test_3InstanceStruct
...
static real_T c1_norm(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
                      real_T c1_x[16]);
static void c1_eml_warning(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance);
static void c1_b_eml_warning(SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance,
  real_T c1_varargin_3);
static void c1_e_eml_scalar_eg(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
...
static void c1_emlrt_marshallIn(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, const mxArray *c1_Fout, const char_T *c1_name, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, const mxArray *c1_acc_out, const char_T *c1_name, real_T c1_y
  [5]);
static void c1_c_emlrt_marshallIn(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, const mxArray *c1_pdot, const char_T *c1_name, real_T c1_y[6]);
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_DVM_Nikola_test_3, const
  char_T *c1_name);
static void init_dsm_address_info(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Nikola_test_3 = 0U;
}
  ...
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_DVM_Nikola_test_3;
  ...
  (SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Nikola_test_3 = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_DVM_Nikola_test_3");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DVM_Nikola_test_3(chartInstance);
  ...
  *chartInstance)
{
  ...
  c1_c1_DVM_Nikola_test_3(chartInstance);
  _sfEvent_ = c1_previousEvent;
  sf_debug_check_for_state_inconsistency(_DVM_Nikola_test_3MachineNumber_,
  ...
  *chartInstance)
{
  ...
  int32_T c1_i21;
  real_T c1_acc_in[5];
  uint32_T c1_debug_family_var_map[166];
  static const char *c1_sv0[166] = { "g", "v_x", "v_y", "phi", "phi_d", "psi",
    ...
    "Mass_Matrix", "A1", "B1",
    "C1", "C2", "D1", "D2", "F_c", "F_u", "a_x_new", "a_y_new", "phi_dd_new",
    "psi_dd_new", "nargin"
    , "nargout", "p", "steer", "torque", "acc_in", "pdot", "slp_ang", "acc_out",
    "Fout" };
  ...
  sf_debug_symbol_scope_push_eml(0U, 166U, 166U, c1_sv0, c1_debug_family_var_map);
  ...
  sf_debug_symbol_scope_add_eml(&c1_B1, c1_d_sf_marshall, 145U);
  sf_debug_symbol_scope_add_eml(&c1_C1, c1_d_sf_marshall, 146U);
  sf_debug_symbol_scope_add_eml(&c1_C2, c1_d_sf_marshall, 147U);
  sf_debug_symbol_scope_add_eml(&c1_D1, c1_d_sf_marshall, 148U);
  sf_debug_symbol_scope_add_eml(&c1_D2, c1_d_sf_marshall, 149U);
  sf_debug_symbol_scope_add_eml(c1_F_c, c1_e_sf_marshall, 150U);
  sf_debug_symbol_scope_add_eml(c1_F_u, c1_e_sf_marshall, 151U);
  sf_debug_symbol_scope_add_eml(&c1_a_x_new, c1_d_sf_marshall, 152U);
  sf_debug_symbol_scope_add_eml(&c1_a_y_new, c1_d_sf_marshall, 153U);
  sf_debug_symbol_scope_add_eml(&c1_phi_dd_new, c1_d_sf_marshall, 154U);
  sf_debug_symbol_scope_add_eml(&c1_psi_dd_new, c1_d_sf_marshall, 155U);
  sf_debug_symbol_scope_add_eml(&c1_nargin, c1_d_sf_marshall, 156U);
  sf_debug_symbol_scope_add_eml(&c1_nargout, c1_d_sf_marshall, 157U);
  sf_debug_symbol_scope_add_eml(c1_p, c1_c_sf_marshall, 158U);
  sf_debug_symbol_scope_add_eml(&c1_steer, c1_d_sf_marshall, 159U);
  sf_debug_symbol_scope_add_eml(&c1_torque, c1_d_sf_marshall, 160U);
  sf_debug_symbol_scope_add_eml(c1_acc_in, c1_b_sf_marshall, 161U);
  sf_debug_symbol_scope_add_eml(c1_pdot, c1_c_sf_marshall, 162U);
  sf_debug_symbol_scope_add_eml(c1_slp_ang, c1_sf_marshall, 163U);
  sf_debug_symbol_scope_add_eml(c1_acc_out, c1_b_sf_marshall, 164U);
  sf_debug_symbol_scope_add_eml(c1_Fout, c1_sf_marshall, 165U);
  CV_EML_FCN(0, 0);
  ...
  _SFD_EML_CALL(0, 243);
  c1_db_a = -c1_a_lf;
  c1_Fytlf = c1_db_a * 25726.751950148697;
  _SFD_EML_CALL(0, 244);
  c1_eb_a = -c1_a_rf;
  c1_Fytrf = c1_eb_a * 25726.751950148697;
  _SFD_EML_CALL(0, 245);
  c1_fb_a = -c1_a_lr;
  c1_Fytlr = c1_fb_a * 16081.015549851298;
  _SFD_EML_CALL(0, 246);
  c1_gb_a = -c1_a_rr;
  c1_Fytrr = c1_gb_a * 16081.015549851298;
  _SFD_EML_CALL(0, 248);
  c1_md_x = c1_delta;
  c1_nd_x = c1_md_x;
  c1_od_x = c1_nd_x;
  ...
  _SFD_EML_CALL(0, 268);
  c1_ac_b = c1_phi;
  c1_ad_y = -47298.369313023613 * c1_ac_b;
  c1_bc_b = c1_phi_d;
  c1_bd_y = 2717.2476562 * c1_bc_b;
  c1_T_phif = c1_ad_y - c1_bd_y;
  _SFD_EML_CALL(0, 269);
  c1_cc_b = c1_phi;
  c1_cd_y = -37310.859108305551 * c1_cc_b;
  c1_dc_b = c1_phi_d;
  c1_dd_y = 2895.6587717249995 * c1_dc_b;
  ...
  c1_ec_b = c1_me_x;
  c1_ed_y = 6673.7516684110269 * c1_ec_b;
  c1_sigTxs = (c1_T_phif + c1_T_phir) - c1_ed_y;

  /*  sigTxs  = T_phif + T_phir - ... */
  /*            M_s*g*h_s*sin(phi) + M_s*h_s*a_sy*cos(phi); */
  _SFD_EML_CALL(0, 279);
  c1_lb_a = c1_Fylf + c1_Fyrf;
  c1_fd_y = c1_lb_a * 1.0346864809057312;
  c1_mb_a = c1_Fylr + c1_Fyrr;
  c1_gd_y = c1_mb_a * 1.6553135190942689;
  c1_fc_b = c1_Fxlf - c1_Fxrf;
  c1_hd_y = 0.77 * c1_fc_b;
  c1_sigTz = (((((c1_fd_y - c1_gd_y) + c1_hd_y) + c1_Mzlf) + c1_Mzrf) + c1_Mzlr)
    + c1_Mzrr;
  ...
  c1_gc_b = c1_pe_x;
  c1_Am = 680.300883630074 * c1_gc_b;
  _SFD_EML_CALL(0, 360);
  c1_re_x = c1_phi;
  c1_se_x = c1_re_x;
  c1_te_x = c1_se_x;
  ...
  c1_hc_b = c1_se_x;
  c1_Bm = -680.300883630074 * c1_hc_b;
  _SFD_EML_CALL(0, 361);
  c1_ue_x = c1_phi;
  c1_ve_x = c1_ue_x;
  c1_we_x = c1_ve_x;
  ...
  c1_ic_b = c1_ve_x;
  c1_Cm = 21.096972567806741 * c1_ic_b;
  _SFD_EML_CALL(0, 362);
  c1_xe_x = c1_phi;
  c1_ye_x = c1_xe_x;
  c1_af_x = c1_ye_x;
  c1_ye_x = c1_af_x;
  c1_ye_x = muDoubleScalarSin(c1_ye_x);
  c1_jc_b = c1_ye_x;
  c1_Dm1 = 680.300883630074 * c1_jc_b;
  _SFD_EML_CALL(0, 363);
  c1_bf_x = c1_phi;
  c1_cf_x = c1_bf_x;
  c1_df_x = c1_cf_x;
  ...
  c1_kc_b = c1_cf_x;
  c1_Dm2 = 21.096972567806741 * c1_kc_b;
  _SFD_EML_CALL(0, 365);
  c1_ef_x = c1_phi;
  c1_ff_x = c1_ef_x;
  c1_gf_x = c1_ff_x;
  ...
  c1_lc_b = c1_ff_x;
  c1_id_y = 680.300883630074 * c1_lc_b;
  c1_hf_x = c1_phi;
  c1_if_x = c1_hf_x;
  c1_jf_x = c1_if_x;
  c1_if_x = c1_jf_x;
  ...
  c1_mc_b = c1_if_x;
  c1_jd_y = -680.300883630074 * c1_mc_b;
  c1_kf_x = c1_phi;
  c1_lf_x = c1_kf_x;
  c1_mf_x = c1_lf_x;
  c1_lf_x = c1_mf_x;
  c1_lf_x = muDoubleScalarSin(c1_lf_x);
  c1_nc_b = c1_mpower(chartInstance, c1_lf_x);
  c1_kd_y = 303.103865523518 * c1_nc_b;
  c1_nf_x = c1_phi;
  c1_of_x = c1_nf_x;
  c1_pf_x = c1_of_x;
  c1_of_x = c1_pf_x;
  ...
  c1_pc_b = c1_rf_x;
  c1_md_y = 680.300883630074 * c1_pc_b;
  c1_tf_x = c1_phi;
  c1_uf_x = c1_tf_x;
  c1_vf_x = c1_uf_x;
  c1_uf_x = c1_vf_x;
  ...
  c1_qc_b = c1_uf_x;
  c1_nd_y = 21.096972567806741 * c1_qc_b;
  c1_Mass_Matrix[0] = c1_M;
  c1_Mass_Matrix[4] = 0.0;
  c1_Mass_Matrix[8] = 0.0;
  c1_Mass_Matrix[12] = c1_id_y;
  c1_Mass_Matrix[1] = 0.0;
  c1_Mass_Matrix[5] = c1_M;
  c1_Mass_Matrix[9] = c1_jd_y;
  c1_Mass_Matrix[13] = 0.0;
  c1_Mass_Matrix[2] = 0.0;
  c1_Mass_Matrix[6] = 0.0;
  c1_Mass_Matrix[10] = c1_I_xxs + c1_kd_y;
  c1_Mass_Matrix[14] = c1_ld_y;
  c1_Mass_Matrix[3] = c1_md_y;
  c1_Mass_Matrix[7] = 0.0;
  c1_Mass_Matrix[11] = c1_nd_y;
  c1_Mass_Matrix[15] = c1_I_zzo;
  ...
  c1_rc_b = c1_xf_x;
  c1_A1 = -1360.6017672601481 * c1_rc_b;
  _SFD_EML_CALL(0, 372);
  c1_ag_x = c1_phi;
  c1_bg_x = c1_ag_x;
  c1_cg_x = c1_bg_x;
  ...
  c1_sc_b = c1_bg_x;
  c1_B1 = -680.300883630074 * c1_sc_b;
  _SFD_EML_CALL(0, 373);
  c1_dg_x = c1_phi;
  c1_eg_x = c1_dg_x;
  c1_fg_x = c1_eg_x;
  ...
  c1_tc_b = c1_eg_x;
  c1_C1 = 21.096972567806741 * c1_tc_b;
  _SFD_EML_CALL(0, 374);
  c1_gg_x = c1_phi;
  c1_hg_x = c1_gg_x;
  c1_ig_x = c1_hg_x;
  ...
  c1_uc_b = c1_hg_x;
  c1_od_y = -182.72386552351787 * c1_uc_b;
  c1_jg_x = c1_phi;
  c1_kg_x = c1_jg_x;
  c1_lg_x = c1_kg_x;
  c1_kg_x = c1_lg_x;
  ...
  c1_wc_b = c1_ng_x;
  c1_D1 = -21.096972567806741 * c1_wc_b;
  _SFD_EML_CALL(0, 376);
  c1_pg_x = c1_phi;
  c1_qg_x = c1_pg_x;
  c1_rg_x = c1_qg_x;
  ...
  c1_xc_b = c1_qg_x;
  c1_pd_y = 182.72386552351787 * c1_xc_b;
  c1_sg_x = c1_phi;
  c1_tg_x = c1_sg_x;
  c1_ug_x = c1_tg_x;
  c1_tg_x = c1_ug_x;
  ...
  c1_pb_a = c1_A1;
  c1_ad_b = c1_phi_d;
  c1_qd_y = c1_pb_a * c1_ad_b;
  c1_qb_a = c1_qd_y;
  c1_bd_b = c1_psi_d;
  c1_rd_y = c1_qb_a * c1_bd_b;
  c1_F_c[0] = c1_sigFx + c1_rd_y;
  _SFD_EML_CALL(0, 381);
  c1_rb_a = c1_B1;
  c1_cd_b = c1_mpower(chartInstance, c1_phi_d) + c1_mpower(chartInstance,
    c1_psi_d);
  c1_sd_y = c1_rb_a * c1_cd_b;
  c1_F_c[1] = c1_sigFy + c1_sd_y;
  _SFD_EML_CALL(0, 383);
  c1_sb_a = c1_C1;
  c1_dd_b = c1_phi_d;
  c1_td_y = c1_sb_a * c1_dd_b;
  c1_tb_a = c1_td_y;
  c1_ed_b = c1_psi_d;
  c1_ud_y = c1_tb_a * c1_ed_b;
  c1_ub_a = c1_C2;
  c1_fd_b = c1_mpower(chartInstance, c1_psi_d);
  c1_vd_y = c1_ub_a * c1_fd_b;
  c1_vg_x = c1_phi;
  c1_wg_x = c1_vg_x;
  c1_xg_x = c1_wg_x;
  c1_wg_x = c1_xg_x;
  c1_wg_x = muDoubleScalarCos(c1_wg_x);
  c1_gd_b = c1_wg_x;
  c1_wd_y = 680.300883630074 * c1_gd_b;
  c1_vb_a = c1_wd_y;
  c1_hd_b = c1_psi_d;
  c1_xd_y = c1_vb_a * c1_hd_b;
  c1_wb_a = c1_xd_y;
  c1_id_b = c1_v_x;
  c1_yd_y = c1_wb_a * c1_id_b;
  c1_yg_x = c1_phi;
  c1_ah_x = c1_yg_x;
  c1_bh_x = c1_ah_x;
  c1_ah_x = c1_bh_x;
  ...
  c1_jd_b = c1_ah_x;
  c1_ae_y = 303.103865523518 * c1_jd_b;
  c1_ch_x = c1_phi;
  c1_dh_x = c1_ch_x;
  c1_eh_x = c1_dh_x;
  c1_dh_x = c1_eh_x;
  c1_dh_x = muDoubleScalarCos(c1_dh_x);
  c1_xb_a = c1_ae_y;
  c1_kd_b = c1_dh_x;
  c1_be_y = c1_xb_a * c1_kd_b;
  c1_yb_a = c1_be_y;
  c1_ld_b = c1_mpower(chartInstance, c1_phi_d) + c1_mpower(chartInstance,
    c1_psi_d);
  c1_ce_y = c1_yb_a * c1_ld_b;
  c1_F_c[2] = (((c1_sigTxs + c1_ud_y) + c1_vd_y) + c1_yd_y) - c1_ce_y;

  /*
     -M_s*h_s*l_cgs*cos(phi)*psi_dd - M_s*h_s^2*cos(phi)^2*phi_dd = M_s*h_s*cos(phi)*psi_d*v_x - M_s*cos(phi)*h_s^2*phi_d^2*sin(phi) - M_s*h_s^2*cos(phi)*psi_d^2*sin(phi)); */
  _SFD_EML_CALL(0, 387);
  c1_ac_a = c1_D1;
  c1_md_b = c1_mpower(chartInstance, c1_phi_d);
  c1_de_y = c1_ac_a * c1_md_b;
  c1_bc_a = c1_D2;
  c1_nd_b = c1_psi_d;
  c1_ee_y = c1_bc_a * c1_nd_b;
  c1_cc_a = c1_ee_y;
  c1_od_b = c1_phi_d;
  c1_fe_y = c1_cc_a * c1_od_b;
  c1_F_c[3] = (c1_sigTz + c1_de_y) + c1_fe_y;
  ...
  for (c1_i51 = 0; c1_i51 < 4; c1_i51 = c1_i51 + 1) {
    ...
    for (c1_i53 = 0; c1_i53 < 4; c1_i53 = c1_i53 + 1) {
      c1_F_u[c1_i51] = c1_F_u[c1_i51] + c1_m_A[c1_i52 + c1_i51] * c1_g_B[c1_i53];
      c1_i52 = c1_i52 + 4;
    }
  }
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Nikola_test_3InstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
...
const mxArray *sf_c1_DVM_Nikola_test_3_get_eml_resolved_functions_info(void)
{
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Nikola_test_3InstanceStruct
  *chartInstance, const mxArray *
  c1_b_is_active_c1_DVM_Nikola_test_3, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_DVM_Nikola_test_3), &c1_u0,
                1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_DVM_Nikola_test_3);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_DVM_Nikola_test_3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3791445987U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4015687446U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1069843752U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1030412063U);
}

mxArray *sf_c1_DVM_Nikola_test_3_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(1363158529U);
    pr[1] = (double)(989295061U);
    pr[2] = (double)(3929314824U);
    pr[3] = (double)(38051648U);
...
static mxArray *sf_get_sim_state_info_c1_DVM_Nikola_test_3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[11],T\"Fout\",},{M[1],M[10],T\"acc_out\",},{M[1],M[5],T\"pdot\",},{M[1],M[9],T\"slp_ang\",},{M[8],M[0],T\"is_active_c1_DVM_Nikola_test_3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DVM_Nikola_test_3_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance;
    chartInstance = (SFc1_DVM_Nikola_test_3InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_DVM_Nikola_test_3MachineNumber_,
           1,
           1,
           1,
           8,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_DVM_Nikola_test_3MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_DVM_Nikola_test_3MachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_DVM_Nikola_test_3MachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,12366);
      ...
      sf_debug_reset_current_state_configuration
        (_DVM_Nikola_test_3MachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_DVM_Nikola_test_3(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInstanceVar);
  initialize_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_DVM_Nikola_test_3(void *chartInstanceVar)
{
  enable_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_DVM_Nikola_test_3(void *chartInstanceVar)
{
  disable_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_DVM_Nikola_test_3(void *chartInstanceVar)
{
  sf_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_DVM_Nikola_test_3(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DVM_Nikola_test_3
    ((SFc1_DVM_Nikola_test_3InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_DVM_Nikola_test_3();/* state var info */
...
static void sf_internal_set_sim_state_c1_DVM_Nikola_test_3(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DVM_Nikola_test_3();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_DVM_Nikola_test_3(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DVM_Nikola_test_3(S);
}

static void sf_opaque_set_sim_state_c1_DVM_Nikola_test_3(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_DVM_Nikola_test_3(S, st);
}

static void sf_opaque_terminate_c1_DVM_Nikola_test_3(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DVM_Nikola_test_3InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_DVM_Nikola_test_3((SFc1_DVM_Nikola_test_3InstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_DVM_Nikola_test_3
    ((SFc1_DVM_Nikola_test_3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DVM_Nikola_test_3(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_DVM_Nikola_test_3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DVM_Nikola_test_3","DVM_Nikola_test_3",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DVM_Nikola_test_3","DVM_Nikola_test_3",
                1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DVM_Nikola_test_3",
      "DVM_Nikola_test_3",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DVM_Nikola_test_3",
        "DVM_Nikola_test_3",1,4);
      sf_mark_chart_reusable_outputs(S,"DVM_Nikola_test_3","DVM_Nikola_test_3",1,
        4);
    }

    sf_set_rtw_dwork_info(S,"DVM_Nikola_test_3","DVM_Nikola_test_3",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(1369435178U));
  ssSetChecksum1(S,(3274941358U));
  ssSetChecksum2(S,(1999455957U));
  ssSetChecksum3(S,(2832440952U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_DVM_Nikola_test_3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DVM_Nikola_test_3", "DVM_Nikola_test_3",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_DVM_Nikola_test_3(SimStruct *S)
{
  SFc1_DVM_Nikola_test_3InstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Nikola_test_3InstanceStruct *)malloc(sizeof
    (SFc1_DVM_Nikola_test_3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DVM_Nikola_test_3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DVM_Nikola_test_3;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DVM_Nikola_test_3;
...
void c1_DVM_Nikola_test_3_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DVM_Nikola_test_3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DVM_Nikola_test_3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DVM_Nikola_test_3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DVM_Nikola_test_3_method_dispatcher.\n"
