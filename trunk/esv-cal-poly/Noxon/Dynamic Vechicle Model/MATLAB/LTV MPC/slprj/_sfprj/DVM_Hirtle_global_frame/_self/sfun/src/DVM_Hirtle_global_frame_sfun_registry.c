...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_DVM_Hirtle_global_frame_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_DVM_Hirtle_global_frame_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_DVM_Hirtle_global_frame_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_DVM_Hirtle_global_frame_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_DVM_Hirtle_global_frame_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "DVM_Hirtle_global_frame") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_DVM_Hirtle_global_frame_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_DVM_Hirtle_global_frame_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"DVM_Hirtle_global_frame")) {
    return(sf_DVM_Hirtle_global_frame_method_dispatcher(simstructPtr,
...
extern void DVM_Hirtle_global_frame_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    DVM_Hirtle_global_frame_terminator();
    sf_debug_terminate();
  }
...
extern void DVM_Hirtle_global_frame_initializer(void);
extern void DVM_Hirtle_global_frame_register_exported_symbols(SimStruct* S);
extern void DVM_Hirtle_global_frame_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  DVM_Hirtle_global_frame_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      DVM_Hirtle_global_frame_debug_initialize();
    }

    DVM_Hirtle_global_frame_initializer();
  }
