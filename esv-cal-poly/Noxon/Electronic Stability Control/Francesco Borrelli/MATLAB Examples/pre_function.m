function [Xpre,XpreandX]=pre_function(sysStruct,name,uselaprint)
...
if uselaprint
    ...
    text(-2.5,-0.5,'\large Pre($\mathcal{X}$)')
...
%%% reach set 1
% Computing sysStruct.B*U , MPT gives erro since it works only for
% invertible matrices
