...
#include "DVM_Nikola_test_sfun.h"
#include "c1_DVM_Nikola_test.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "DVM_Nikola_test_sfun_debug_macros.h"
...
static const char *c1_debug_family_names[173] = { "g", "v_x", "v_y", "phi",
  ...
  "delta", "a_sx", "a_sy", "a_ufx", "a_ufy", "a_urx", "a_ury", "ROT", "I_b",
  "I_c", "I_zzus", "I_zzo", "Fzax", "Fzayf", "Fzayr", "Fzphif", "Fzphir", "Fzlf",
  "Fzrf", "Fzlr", "Fzrr", "vx_lf", "vy_lf", "vx_rf", "vy_rf", "vx_lr", "vy_lr",
  "vx_rr", "vy_rr", "vc_lf", "vc_rf", "vc_lr", "vc_rr", "vl_lf", "vl_rf",
  "vl_lr", "vl_rr", "a_lf", "a_rf", "a_lr", "a_rr", "C_alf", "C_arf", "C_alr",
  "C_arr", "Fxtlf", "Fxtrf", "Fxtlr", "Fxtrr", "Fytlf", "Fytrf", "Fytlr",
  "Fytrr", "Fxlf", "Fxrf", "Fxlr", "Fxrr", "Fylf", "Fyrf", "Fylr", "Fyrr",
  "Mzlf", "Mzrf", "Mzlr", "Mzrr", "T_phif", "T_phir", "sigFx", "sigFy", "sigTxs",
  "sigTz", "Am", "Bm", "Cm", "Dm1", "Dm2", "Mass_Matrix", "A1", "A2", "A3", "B1",
  "B2", "B3", "B4", "C1", "C2", "C3", "D1", "D2", "D3", "F_c", "F_u", "a_x_new",
  "a_y_new", "phi_dd_new", "psi_dd_new", "nargin", "nargout", "p", "steer",
  "torque", "acc_in", "pdot", "slp_ang", "acc_out", "Fout" };

/* Function Declarations */
static void initialize_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
static void initialize_params_c1_DVM_Nikola_test
  (SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void enable_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
static void disable_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_DVM_Nikola_test
  (SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DVM_Nikola_test
  (SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void set_sim_state_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void finalize_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
static void sf_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
static void c1_c1_DVM_Nikola_test(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c1_DVM_Nikola_test
  (SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static real_T c1_mpower(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  real_T c1_a);
static real_T c1_power(SFc1_DVM_Nikola_testInstanceStruct *chartInstance, real_T
  c1_a, real_T c1_b);
static void c1_eml_scalar_eg(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_eml_error(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_eml_xgemm(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  real_T c1_A[9], real_T c1_B[9], real_T c1_C[9], real_T c1_b_C[9]);
static void c1_b_mpower(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  real_T c1_a[16], real_T c1_c[16]);
static void c1_matrix_to_integer_power(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, real_T c1_a[16], real_T c1_b, real_T c1_c[16]);
static void c1_c_eml_scalar_eg(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_d_eml_scalar_eg(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_invNxN(SFc1_DVM_Nikola_testInstanceStruct *chartInstance, real_T
                      c1_x[16], real_T c1_y[16]);
static void c1_eps(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4],
  int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0);
static int32_T c1_ceval_ixamax(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx);
static void c1_ceval_xswap(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx, int32_T c1_iy0,
  int32_T c1_incy, real_T c1_b_x[16]);
static void c1_ceval_xger(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
...
static void c1_eml_blas_xtrsm(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  ...
  c1_b_B[16]);
static real_T c1_norm(SFc1_DVM_Nikola_testInstanceStruct *chartInstance, real_T
                      c1_x[16]);
static void c1_eml_warning(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
static void c1_b_eml_warning(SFc1_DVM_Nikola_testInstanceStruct *chartInstance,
  real_T c1_varargin_3);
static void c1_e_eml_scalar_eg(SFc1_DVM_Nikola_testInstanceStruct *chartInstance);
...
static void c1_emlrt_marshallIn(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, const mxArray *c1_Fout, const char_T *c1_name, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, const mxArray *c1_acc_out, const char_T *c1_name, real_T c1_y
  [5]);
static void c1_c_emlrt_marshallIn(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, const mxArray *c1_pdot, const char_T *c1_name, real_T c1_y[6]);
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_DVM_Nikola_test, const char_T
  *c1_name);
static void init_dsm_address_info(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Nikola_test = 0U;
}
  ...
  (SFc1_DVM_Nikola_testInstanceStruct *chartInstance)
{
  ...
  c1_d_y = NULL;
  sf_mex_assign(&c1_d_y, sf_mex_create("y", c1_c_u, 0, 0U, 1U, 0U, 1, 6));
  sf_mex_setcell(c1_y, 2, c1_d_y);
  for (c1_i6 = 0; c1_i6 < 4; c1_i6 = c1_i6 + 1) {
    c1_d_hoistedGlobal[c1_i6] = (*c1_slp_ang)[c1_i6];
  }
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_DVM_Nikola_test;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  for (c1_i8 = 0; c1_i8 < 4; c1_i8 = c1_i8 + 1) {
    (*c1_Fout)[c1_i8] = c1_dv0[c1_i8];
  }

  c1_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
                        "acc_out", c1_dv1);
  for (c1_i9 = 0; c1_i9 < 5; c1_i9 = c1_i9 + 1) {
    (*c1_acc_out)[c1_i9] = c1_dv1[c1_i9];
  }

  c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
                        "pdot", c1_dv2);
  for (c1_i10 = 0; c1_i10 < 6; c1_i10 = c1_i10 + 1) {
    (*c1_pdot)[c1_i10] = c1_dv2[c1_i10];
  }

  c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 3)),
                      "slp_ang", c1_dv3);
  for (c1_i11 = 0; c1_i11 < 4; c1_i11 = c1_i11 + 1) {
    (*c1_slp_ang)[c1_i11] = c1_dv3[c1_i11];
  }

  chartInstance->c1_is_active_c1_DVM_Nikola_test = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_DVM_Nikola_test");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DVM_Nikola_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  for (c1_i12 = 0; c1_i12 < 6; c1_i12 = c1_i12 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_p)[c1_i12], 0U);
  }

  for (c1_i13 = 0; c1_i13 < 6; c1_i13 = c1_i13 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_pdot)[c1_i13], 1U);
  }

  _SFD_DATA_RANGE_CHECK(*c1_steer, 2U);
  _SFD_DATA_RANGE_CHECK(*c1_torque, 3U);
  for (c1_i14 = 0; c1_i14 < 5; c1_i14 = c1_i14 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_acc_in)[c1_i14], 4U);
  }

  for (c1_i15 = 0; c1_i15 < 4; c1_i15 = c1_i15 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_slp_ang)[c1_i15], 5U);
  }

  for (c1_i16 = 0; c1_i16 < 5; c1_i16 = c1_i16 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_acc_out)[c1_i16], 6U);
  }

  for (c1_i17 = 0; c1_i17 < 4; c1_i17 = c1_i17 + 1) {
    _SFD_DATA_RANGE_CHECK((*c1_Fout)[c1_i17], 7U);
  }

  c1_previousEvent = _sfEvent_;
  _sfEvent_ = CALL_EVENT;
  c1_c1_DVM_Nikola_test(chartInstance);
  _sfEvent_ = c1_previousEvent;
  sf_debug_check_for_state_inconsistency(_DVM_Nikola_testMachineNumber_,
  ...
  *chartInstance)
{
  ...
  int32_T c1_i21;
  real_T c1_acc_in[5];
  uint32_T c1_debug_family_var_map[173];
  static const char *c1_sv0[173] = { "g", "v_x", "v_y", "phi", "phi_d", "psi",
    ...
    "vx_lf", "vy_lf",
    "vx_rf", "vy_rf", "vx_lr", "vy_lr", "vx_rr", "vy_rr", "vc_lf", "vc_rf",
    "vc_lr", "vc_rr", "vl_lf"
    , "vl_rf", "vl_lr", "vl_rr", "a_lf", "a_rf", "a_lr", "a_rr", "C_alf",
    "C_arf", "C_alr", "C_arr",
    "Fxtlf", "Fxtrf", "Fxtlr", "Fxtrr", "Fytlf", "Fytrf", "Fytlr", "Fytrr",
    "Fxlf", "Fxrf", "Fxlr",
    "Fxrr", "Fylf", "Fyrf", "Fylr", "Fyrr", "Mzlf", "Mzrf", "Mzlr", "Mzrr",
    "T_phif", "T_phir",
    "sigFx", "sigFy", "sigTxs", "sigTz", "Am", "Bm", "Cm", "Dm1", "Dm2",
    "Mass_Matrix", "A1", "A2",
    "A3", "B1", "B2", "B3", "B4", "C1", "C2", "C3", "D1", "D2", "D3", "F_c",
    "F_u", "a_x_new",
    "a_y_new", "phi_dd_new", "psi_dd_new", "nargin", "nargout", "p", "steer",
    "torque", "acc_in",
    "pdot", "slp_ang", "acc_out", "Fout" };
  ...
  real_T c1_Fout[4];
  int32_T c1_i22;
  static real_T c1_dv4[8] = { 0.0, 0.1, 0.15, 1.0, 0.0, 0.6, 0.85, 0.4 };

  int32_T c1_i23;
  static real_T c1_dv5[10] = { 0.0, 0.08, 0.15, 0.3, 1.0, 0.0, 0.4, 0.6, 0.8,
    0.4 };

  int32_T c1_i24;
  static real_T c1_dv6[8] = { 0.0, 0.1, 0.3, 1.0, 0.0, 0.0005, 0.00025, 0.0 };
  ...
  int32_T c1_i25;
  int32_T c1_i26;
  static real_T c1_dv7[3] = { 1.0, 0.0, 0.0 };

  int32_T c1_i27;
  static real_T c1_dv8[9] = { 744.014865523518, 0.0, 21.096972567806741, 0.0,
  ...
  for (c1_i18 = 0; c1_i18 < 6; c1_i18 = c1_i18 + 1) {
    c1_hoistedGlobal[c1_i18] = (*c1_b_p)[c1_i18];
  }

  c1_b_hoistedGlobal = *c1_b_steer;
  c1_c_hoistedGlobal = *c1_b_torque;
  for (c1_i19 = 0; c1_i19 < 5; c1_i19 = c1_i19 + 1) {
    c1_d_hoistedGlobal[c1_i19] = (*c1_b_acc_in)[c1_i19];
  }

  for (c1_i20 = 0; c1_i20 < 6; c1_i20 = c1_i20 + 1) {
    c1_p[c1_i20] = c1_hoistedGlobal[c1_i20];
  }

  c1_steer = c1_b_hoistedGlobal;
  c1_torque = c1_c_hoistedGlobal;
  for (c1_i21 = 0; c1_i21 < 5; c1_i21 = c1_i21 + 1) {
    c1_acc_in[c1_i21] = c1_d_hoistedGlobal[c1_i21];
  }

  sf_debug_symbol_scope_push_eml(0U, 173U, 173U, c1_sv0, c1_debug_family_var_map);
  ...
  sf_debug_symbol_scope_add_eml(&c1_a_x, c1_d_sf_marshall, 7U);
  sf_debug_symbol_scope_add_eml(&c1_a_y, c1_d_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(&c1_phi_dd, c1_d_sf_marshall, 9U);
  sf_debug_symbol_scope_add_eml(&c1_psi_dd, c1_d_sf_marshall, 10U);
  sf_debug_symbol_scope_add_eml(&c1_l_fs, c1_d_sf_marshall, 11U);
  sf_debug_symbol_scope_add_eml(&c1_l_rs, c1_d_sf_marshall, 12U);
  sf_debug_symbol_scope_add_eml(&c1_t_f, c1_d_sf_marshall, 13U);
  sf_debug_symbol_scope_add_eml(&c1_t_r, c1_d_sf_marshall, 14U);
  sf_debug_symbol_scope_add_eml(&c1_h_f, c1_d_sf_marshall, 15U);
  sf_debug_symbol_scope_add_eml(&c1_h_r, c1_d_sf_marshall, 16U);
  sf_debug_symbol_scope_add_eml(&c1_h_cgs, c1_d_sf_marshall, 17U);
  sf_debug_symbol_scope_add_eml(&c1_h_cguf, c1_d_sf_marshall, 18U);
  sf_debug_symbol_scope_add_eml(&c1_h_cgur, c1_d_sf_marshall, 19U);
  sf_debug_symbol_scope_add_eml(&c1_M, c1_d_sf_marshall, 20U);
  sf_debug_symbol_scope_add_eml(&c1_M_uf, c1_d_sf_marshall, 21U);
  sf_debug_symbol_scope_add_eml(&c1_M_ur, c1_d_sf_marshall, 22U);
  sf_debug_symbol_scope_add_eml(&c1_I_xxs, c1_d_sf_marshall, 23U);
  sf_debug_symbol_scope_add_eml(&c1_I_xys, c1_d_sf_marshall, 24U);
  sf_debug_symbol_scope_add_eml(&c1_I_xzs, c1_d_sf_marshall, 25U);
  sf_debug_symbol_scope_add_eml(&c1_I_yys, c1_d_sf_marshall, 26U);
  sf_debug_symbol_scope_add_eml(&c1_I_yzs, c1_d_sf_marshall, 27U);
  sf_debug_symbol_scope_add_eml(&c1_I_zzs, c1_d_sf_marshall, 28U);
  sf_debug_symbol_scope_add_eml(&c1_I_zzuf, c1_d_sf_marshall, 29U);
  sf_debug_symbol_scope_add_eml(&c1_I_zzur, c1_d_sf_marshall, 30U);
  sf_debug_symbol_scope_add_eml(&c1_I_tlf, c1_d_sf_marshall, 31U);
  sf_debug_symbol_scope_add_eml(&c1_I_trf, c1_d_sf_marshall, 32U);
  sf_debug_symbol_scope_add_eml(&c1_I_tlr, c1_d_sf_marshall, 33U);
  sf_debug_symbol_scope_add_eml(&c1_I_trr, c1_d_sf_marshall, 34U);
  sf_debug_symbol_scope_add_eml(&c1_K_spf, c1_d_sf_marshall, 35U);
  sf_debug_symbol_scope_add_eml(&c1_K_spr, c1_d_sf_marshall, 36U);
  sf_debug_symbol_scope_add_eml(&c1_B_f, c1_d_sf_marshall, 37U);
  sf_debug_symbol_scope_add_eml(&c1_B_r, c1_d_sf_marshall, 38U);
  sf_debug_symbol_scope_add_eml(&c1_K_rf, c1_d_sf_marshall, 39U);
  sf_debug_symbol_scope_add_eml(&c1_K_rr, c1_d_sf_marshall, 40U);
  sf_debug_symbol_scope_add_eml(&c1_K_phif, c1_d_sf_marshall, 41U);
  sf_debug_symbol_scope_add_eml(&c1_K_phir, c1_d_sf_marshall, 42U);
  sf_debug_symbol_scope_add_eml(&c1_K_phi, c1_d_sf_marshall, 43U);
  sf_debug_symbol_scope_add_eml(&c1_B_phif, c1_d_sf_marshall, 44U);
  sf_debug_symbol_scope_add_eml(&c1_B_phir, c1_d_sf_marshall, 45U);
  sf_debug_symbol_scope_add_eml(&c1_B_phi, c1_d_sf_marshall, 46U);
  sf_debug_symbol_scope_add_eml(&c1_K_sr, c1_d_sf_marshall, 47U);
  sf_debug_symbol_scope_add_eml(&c1_L, c1_d_sf_marshall, 48U);
  sf_debug_symbol_scope_add_eml(&c1_M_s, c1_d_sf_marshall, 49U);
  sf_debug_symbol_scope_add_eml(&c1_l_cgs, c1_d_sf_marshall, 50U);
  sf_debug_symbol_scope_add_eml(&c1_l_f, c1_d_sf_marshall, 51U);
  sf_debug_symbol_scope_add_eml(&c1_l_r, c1_d_sf_marshall, 52U);
  sf_debug_symbol_scope_add_eml(&c1_M_f, c1_d_sf_marshall, 53U);
  sf_debug_symbol_scope_add_eml(&c1_M_r, c1_d_sf_marshall, 54U);
  sf_debug_symbol_scope_add_eml(&c1_h_o, c1_d_sf_marshall, 55U);
  sf_debug_symbol_scope_add_eml(&c1_h_s, c1_d_sf_marshall, 56U);
  sf_debug_symbol_scope_add_eml(&c1_h_uf, c1_d_sf_marshall, 57U);
  sf_debug_symbol_scope_add_eml(&c1_h_ur, c1_d_sf_marshall, 58U);
  sf_debug_symbol_scope_add_eml(&c1_h_cg, c1_d_sf_marshall, 59U);
  sf_debug_symbol_scope_add_eml(c1_varx, c1_h_sf_marshall, 60U);
  sf_debug_symbol_scope_add_eml(c1_vary, c1_i_sf_marshall, 61U);
  sf_debug_symbol_scope_add_eml(c1_varM, c1_h_sf_marshall, 62U);
  sf_debug_symbol_scope_add_eml(&c1_t_wid, c1_d_sf_marshall, 63U);
  sf_debug_symbol_scope_add_eml(&c1_t_rad, c1_d_sf_marshall, 64U);
  sf_debug_symbol_scope_add_eml(&c1_t_pressure, c1_d_sf_marshall, 65U);
  sf_debug_symbol_scope_add_eml(&c1_d_steer, c1_d_sf_marshall, 66U);
  sf_debug_symbol_scope_add_eml(&c1_delta, c1_d_sf_marshall, 67U);
  sf_debug_symbol_scope_add_eml(&c1_a_sx, c1_d_sf_marshall, 68U);
  sf_debug_symbol_scope_add_eml(&c1_a_sy, c1_d_sf_marshall, 69U);
  sf_debug_symbol_scope_add_eml(&c1_a_ufx, c1_d_sf_marshall, 70U);
  sf_debug_symbol_scope_add_eml(&c1_a_ufy, c1_d_sf_marshall, 71U);
  sf_debug_symbol_scope_add_eml(&c1_a_urx, c1_d_sf_marshall, 72U);
  sf_debug_symbol_scope_add_eml(&c1_a_ury, c1_d_sf_marshall, 73U);
  sf_debug_symbol_scope_add_eml(c1_ROT, c1_g_sf_marshall, 74U);
  sf_debug_symbol_scope_add_eml(c1_I_b, c1_g_sf_marshall, 75U);
  sf_debug_symbol_scope_add_eml(c1_I_c, c1_g_sf_marshall, 76U);
  sf_debug_symbol_scope_add_eml(&c1_I_zzus, c1_d_sf_marshall, 77U);
  sf_debug_symbol_scope_add_eml(&c1_I_zzo, c1_d_sf_marshall, 78U);
  sf_debug_symbol_scope_add_eml(&c1_Fzax, c1_d_sf_marshall, 79U);
  sf_debug_symbol_scope_add_eml(&c1_Fzayf, c1_d_sf_marshall, 80U);
  sf_debug_symbol_scope_add_eml(&c1_Fzayr, c1_d_sf_marshall, 81U);
  sf_debug_symbol_scope_add_eml(&c1_Fzphif, c1_d_sf_marshall, 82U);
  sf_debug_symbol_scope_add_eml(&c1_Fzphir, c1_d_sf_marshall, 83U);
  sf_debug_symbol_scope_add_eml(&c1_Fzlf, c1_d_sf_marshall, 84U);
  sf_debug_symbol_scope_add_eml(&c1_Fzrf, c1_d_sf_marshall, 85U);
  sf_debug_symbol_scope_add_eml(&c1_Fzlr, c1_d_sf_marshall, 86U);
  sf_debug_symbol_scope_add_eml(&c1_Fzrr, c1_d_sf_marshall, 87U);
  sf_debug_symbol_scope_add_eml(&c1_vx_lf, c1_d_sf_marshall, 88U);
  sf_debug_symbol_scope_add_eml(&c1_vy_lf, c1_d_sf_marshall, 89U);
  sf_debug_symbol_scope_add_eml(&c1_vx_rf, c1_d_sf_marshall, 90U);
  sf_debug_symbol_scope_add_eml(&c1_vy_rf, c1_d_sf_marshall, 91U);
  sf_debug_symbol_scope_add_eml(&c1_vx_lr, c1_d_sf_marshall, 92U);
  sf_debug_symbol_scope_add_eml(&c1_vy_lr, c1_d_sf_marshall, 93U);
  sf_debug_symbol_scope_add_eml(&c1_vx_rr, c1_d_sf_marshall, 94U);
  sf_debug_symbol_scope_add_eml(&c1_vy_rr, c1_d_sf_marshall, 95U);
  sf_debug_symbol_scope_add_eml(&c1_vc_lf, c1_d_sf_marshall, 96U);
  sf_debug_symbol_scope_add_eml(&c1_vc_rf, c1_d_sf_marshall, 97U);
  sf_debug_symbol_scope_add_eml(&c1_vc_lr, c1_d_sf_marshall, 98U);
  sf_debug_symbol_scope_add_eml(&c1_vc_rr, c1_d_sf_marshall, 99U);
  sf_debug_symbol_scope_add_eml(&c1_vl_lf, c1_d_sf_marshall, 100U);
  sf_debug_symbol_scope_add_eml(&c1_vl_rf, c1_d_sf_marshall, 101U);
  sf_debug_symbol_scope_add_eml(&c1_vl_lr, c1_d_sf_marshall, 102U);
  sf_debug_symbol_scope_add_eml(&c1_vl_rr, c1_d_sf_marshall, 103U);
  sf_debug_symbol_scope_add_eml(&c1_a_lf, c1_d_sf_marshall, 104U);
  sf_debug_symbol_scope_add_eml(&c1_a_rf, c1_d_sf_marshall, 105U);
  sf_debug_symbol_scope_add_eml(&c1_a_lr, c1_d_sf_marshall, 106U);
  sf_debug_symbol_scope_add_eml(&c1_a_rr, c1_d_sf_marshall, 107U);
  sf_debug_symbol_scope_add_eml(&c1_C_alf, c1_d_sf_marshall, 108U);
  sf_debug_symbol_scope_add_eml(&c1_C_arf, c1_d_sf_marshall, 109U);
  sf_debug_symbol_scope_add_eml(&c1_C_alr, c1_d_sf_marshall, 110U);
  sf_debug_symbol_scope_add_eml(&c1_C_arr, c1_d_sf_marshall, 111U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtlf, c1_d_sf_marshall, 112U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtrf, c1_d_sf_marshall, 113U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtlr, c1_d_sf_marshall, 114U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtrr, c1_d_sf_marshall, 115U);
  sf_debug_symbol_scope_add_eml(&c1_Fytlf, c1_d_sf_marshall, 116U);
  sf_debug_symbol_scope_add_eml(&c1_Fytrf, c1_d_sf_marshall, 117U);
  sf_debug_symbol_scope_add_eml(&c1_Fytlr, c1_d_sf_marshall, 118U);
  sf_debug_symbol_scope_add_eml(&c1_Fytrr, c1_d_sf_marshall, 119U);
  sf_debug_symbol_scope_add_eml(&c1_Fxlf, c1_d_sf_marshall, 120U);
  sf_debug_symbol_scope_add_eml(&c1_Fxrf, c1_d_sf_marshall, 121U);
  sf_debug_symbol_scope_add_eml(&c1_Fxlr, c1_d_sf_marshall, 122U);
  sf_debug_symbol_scope_add_eml(&c1_Fxrr, c1_d_sf_marshall, 123U);
  sf_debug_symbol_scope_add_eml(&c1_Fylf, c1_d_sf_marshall, 124U);
  sf_debug_symbol_scope_add_eml(&c1_Fyrf, c1_d_sf_marshall, 125U);
  sf_debug_symbol_scope_add_eml(&c1_Fylr, c1_d_sf_marshall, 126U);
  sf_debug_symbol_scope_add_eml(&c1_Fyrr, c1_d_sf_marshall, 127U);
  sf_debug_symbol_scope_add_eml(&c1_Mzlf, c1_d_sf_marshall, 128U);
  sf_debug_symbol_scope_add_eml(&c1_Mzrf, c1_d_sf_marshall, 129U);
  sf_debug_symbol_scope_add_eml(&c1_Mzlr, c1_d_sf_marshall, 130U);
  sf_debug_symbol_scope_add_eml(&c1_Mzrr, c1_d_sf_marshall, 131U);
  sf_debug_symbol_scope_add_eml(&c1_T_phif, c1_d_sf_marshall, 132U);
  sf_debug_symbol_scope_add_eml(&c1_T_phir, c1_d_sf_marshall, 133U);
  sf_debug_symbol_scope_add_eml(&c1_sigFx, c1_d_sf_marshall, 134U);
  sf_debug_symbol_scope_add_eml(&c1_sigFy, c1_d_sf_marshall, 135U);
  sf_debug_symbol_scope_add_eml(&c1_sigTxs, c1_d_sf_marshall, 136U);
  sf_debug_symbol_scope_add_eml(&c1_sigTz, c1_d_sf_marshall, 137U);
  sf_debug_symbol_scope_add_eml(&c1_Am, c1_d_sf_marshall, 138U);
  sf_debug_symbol_scope_add_eml(&c1_Bm, c1_d_sf_marshall, 139U);
  sf_debug_symbol_scope_add_eml(&c1_Cm, c1_d_sf_marshall, 140U);
  sf_debug_symbol_scope_add_eml(&c1_Dm1, c1_d_sf_marshall, 141U);
  sf_debug_symbol_scope_add_eml(&c1_Dm2, c1_d_sf_marshall, 142U);
  sf_debug_symbol_scope_add_eml(c1_Mass_Matrix, c1_f_sf_marshall, 143U);
  sf_debug_symbol_scope_add_eml(&c1_A1, c1_d_sf_marshall, 144U);
  sf_debug_symbol_scope_add_eml(&c1_A2, c1_d_sf_marshall, 145U);
  sf_debug_symbol_scope_add_eml(&c1_A3, c1_d_sf_marshall, 146U);
  sf_debug_symbol_scope_add_eml(&c1_B1, c1_d_sf_marshall, 147U);
  sf_debug_symbol_scope_add_eml(&c1_B2, c1_d_sf_marshall, 148U);
  sf_debug_symbol_scope_add_eml(&c1_B3, c1_d_sf_marshall, 149U);
  sf_debug_symbol_scope_add_eml(&c1_B4, c1_d_sf_marshall, 150U);
  sf_debug_symbol_scope_add_eml(&c1_C1, c1_d_sf_marshall, 151U);
  sf_debug_symbol_scope_add_eml(&c1_C2, c1_d_sf_marshall, 152U);
  sf_debug_symbol_scope_add_eml(&c1_C3, c1_d_sf_marshall, 153U);
  sf_debug_symbol_scope_add_eml(&c1_D1, c1_d_sf_marshall, 154U);
  sf_debug_symbol_scope_add_eml(&c1_D2, c1_d_sf_marshall, 155U);
  sf_debug_symbol_scope_add_eml(&c1_D3, c1_d_sf_marshall, 156U);
  sf_debug_symbol_scope_add_eml(c1_F_c, c1_e_sf_marshall, 157U);
  sf_debug_symbol_scope_add_eml(c1_F_u, c1_e_sf_marshall, 158U);
  sf_debug_symbol_scope_add_eml(&c1_a_x_new, c1_d_sf_marshall, 159U);
  sf_debug_symbol_scope_add_eml(&c1_a_y_new, c1_d_sf_marshall, 160U);
  sf_debug_symbol_scope_add_eml(&c1_phi_dd_new, c1_d_sf_marshall, 161U);
  sf_debug_symbol_scope_add_eml(&c1_psi_dd_new, c1_d_sf_marshall, 162U);
  sf_debug_symbol_scope_add_eml(&c1_nargin, c1_d_sf_marshall, 163U);
  sf_debug_symbol_scope_add_eml(&c1_nargout, c1_d_sf_marshall, 164U);
  sf_debug_symbol_scope_add_eml(c1_p, c1_c_sf_marshall, 165U);
  sf_debug_symbol_scope_add_eml(&c1_steer, c1_d_sf_marshall, 166U);
  sf_debug_symbol_scope_add_eml(&c1_torque, c1_d_sf_marshall, 167U);
  sf_debug_symbol_scope_add_eml(c1_acc_in, c1_b_sf_marshall, 168U);
  sf_debug_symbol_scope_add_eml(c1_pdot, c1_c_sf_marshall, 169U);
  sf_debug_symbol_scope_add_eml(c1_slp_ang, c1_sf_marshall, 170U);
  sf_debug_symbol_scope_add_eml(c1_acc_out, c1_b_sf_marshall, 171U);
  sf_debug_symbol_scope_add_eml(c1_Fout, c1_sf_marshall, 172U);
  CV_EML_FCN(0, 0);
  ...
  /* ==tire properties==% */
  _SFD_EML_CALL(0, 86);
  for (c1_i22 = 0; c1_i22 < 8; c1_i22 = c1_i22 + 1) {
    c1_varx[c1_i22] = c1_dv4[c1_i22];
  }

  /* slip curve coordinates (slip-%, mu) */
  _SFD_EML_CALL(0, 91);
  for (c1_i23 = 0; c1_i23 < 10; c1_i23 = c1_i23 + 1) {
    c1_vary[c1_i23] = c1_dv5[c1_i23];
  }

  /* slip curve coordinates (slip-%, mu)  */
  _SFD_EML_CALL(0, 97);
  for (c1_i24 = 0; c1_i24 < 8; c1_i24 = c1_i24 + 1) {
    c1_varM[c1_i24] = c1_dv6[c1_i24];
  }
  ...
  c1_b_y = c1_b_a * c1_b;
  c1_b_b = c1_phi_d;
  c1_c_y = 0.89108767257852384 * c1_b_b;
  c1_c_a = c1_c_y;
  c1_c_b = c1_psi_d;
  ...
  c1_f_y = 0.019926480905731212 * c1_e_b;
  c1_a_sx = ((c1_a_x - c1_b_y) - c1_e_y) - c1_f_y;
  _SFD_EML_CALL(0, 121);
  c1_e_a = c1_psi_d;
  c1_f_b = c1_v_x;
  c1_g_y = c1_e_a * c1_f_b;
  c1_g_b = c1_psi_dd;
  c1_h_y = 0.019926480905731212 * c1_g_b;
  c1_g_x = c1_phi;
  c1_h_x = c1_g_x;
  c1_i_x = c1_h_x;
  c1_h_x = c1_i_x;
  ...
  c1_h_b = c1_h_x;
  c1_i_y = 0.44554383628926192 * c1_h_b;
  c1_f_a = c1_i_y;
  c1_i_b = c1_phi_dd;
  c1_j_y = c1_f_a * c1_i_b;
  c1_j_b = c1_mpower(chartInstance, c1_phi_d);
  c1_k_y = 0.44554383628926192 * c1_j_b;
  c1_j_x = c1_phi;
  c1_k_x = c1_j_x;
  c1_l_x = c1_k_x;
  c1_k_x = c1_l_x;
  ...
  c1_l_b = c1_mpower(chartInstance, c1_psi_d);
  c1_m_y = 0.44554383628926192 * c1_l_b;
  c1_m_x = c1_phi;
  c1_n_x = c1_m_x;
  c1_o_x = c1_n_x;
  c1_n_x = c1_o_x;
  ...
  c1_h_a = c1_m_y;
  c1_m_b = c1_n_x;
  c1_n_y = c1_h_a * c1_m_b;
  c1_a_sy = (((c1_g_y + c1_h_y) + c1_j_y) - c1_l_y) - c1_n_y;
  _SFD_EML_CALL(0, 126);
  c1_n_b = c1_mpower(chartInstance, c1_psi_d);
  c1_o_y = 1.0346864809057312 * c1_n_b;
  c1_a_ufx = c1_a_x - c1_o_y;
  _SFD_EML_CALL(0, 127);
  c1_o_b = c1_psi_dd;
  c1_p_y = 1.0346864809057312 * c1_o_b;
  c1_a_ufy = c1_a_y + c1_p_y;
  _SFD_EML_CALL(0, 128);
  c1_p_b = c1_mpower(chartInstance, c1_psi_d);
  c1_q_y = 1.6553135190942689 * c1_p_b;
  c1_a_urx = c1_a_x + c1_q_y;
  _SFD_EML_CALL(0, 129);
  c1_q_b = c1_psi_dd;
  c1_r_y = 1.6553135190942689 * c1_q_b;
  c1_a_ury = c1_a_y - c1_r_y;
  ...
  c1_eml_xgemm(chartInstance, c1_j_a, c1_dv9, c1_dv10, c1_s_y);
  for (c1_i32 = 0; c1_i32 < 9; c1_i32 = c1_i32 + 1) {
    c1_k_a[c1_i32] = c1_s_y[c1_i32];
  }
  ...
  for (c1_i34 = 0; c1_i34 < 3; c1_i34 = c1_i34 + 1) {
    ...
    for (c1_i36 = 0; c1_i36 < 3; c1_i36 = c1_i36 + 1) {
      c1_r_b[c1_i36 + c1_i33] = c1_ROT[c1_i35 + c1_i34];
      c1_i35 = c1_i35 + 3;
    }
  ...
  for (c1_i37 = 0; c1_i37 < 9; c1_i37 = c1_i37 + 1) {
    c1_l_a[c1_i37] = c1_k_a[c1_i37];
  }

  for (c1_i38 = 0; c1_i38 < 9; c1_i38 = c1_i38 + 1) {
    c1_s_b[c1_i38] = c1_r_b[c1_i38];
  }
  ...
  c1_eml_xgemm(chartInstance, c1_l_a, c1_s_b, c1_dv11, c1_dv12);
  for (c1_i40 = 0; c1_i40 < 9; c1_i40 = c1_i40 + 1) {
    c1_I_c[c1_i40] = c1_dv12[c1_i40];
  }
  ...
  _SFD_EML_CALL(0, 151);
  c1_t_b = c1_a_sx;
  c1_t_y = 680.300883630074 * c1_t_b;
  c1_u_b = c1_a_ufx;
  c1_u_y = 19.393667239976594 * c1_u_b;
  c1_v_b = c1_a_urx;
  c1_w_y = 15.756119052254176 * c1_v_b;
  c1_b_A = (c1_t_y + c1_u_y) + c1_w_y;
  c1_db_x = c1_b_A;
  c1_eb_x = c1_db_x;
  c1_fb_x = c1_eb_x;
  c1_Fzax = c1_fb_x / 5.3800000000000008;
  _SFD_EML_CALL(0, 153);
  c1_w_b = c1_a_sy;
  c1_x_y = 122.14675375451863 * c1_w_b;
  c1_x_b = c1_a_ufy;
  c1_y_y = 19.393667239976594 * c1_x_b;
  c1_y_b = c1_x_y + c1_y_y;
  c1_Fzayf = 0.64935064935064934 * c1_y_b;
  _SFD_EML_CALL(0, 154);
  c1_ab_b = c1_a_sy;
  c1_ab_y = 64.604054515407313 * c1_ab_b;
  c1_bb_b = c1_a_ury;
  c1_bb_y = 15.756119052254176 * c1_bb_b;
  c1_cb_b = c1_ab_y + c1_bb_y;
  c1_Fzayr = 0.65359477124183007 * c1_cb_b;
  _SFD_EML_CALL(0, 156);
  c1_db_b = c1_phi;
  c1_cb_y = 47298.369313023613 * c1_db_b;
  c1_eb_b = c1_phi_d;
  c1_db_y = 2717.2476562 * c1_eb_b;
  c1_fb_b = c1_cb_y + c1_db_y;
  c1_Fzphif = -0.64935064935064934 * c1_fb_b;
  _SFD_EML_CALL(0, 157);
  c1_gb_b = c1_phi;
  c1_eb_y = 37310.859108305551 * c1_gb_b;
  c1_hb_b = c1_phi_d;
  c1_fb_y = 2895.6587717249995 * c1_hb_b;
  c1_ib_b = c1_eb_y + c1_fb_y;
  c1_Fzphir = -0.65359477124183007 * c1_ib_b;
  ...
  c1_ib_x = c1_hb_x;
  c1_hb_y = c1_ib_x / 2.0;
  c1_vx_lf = c1_v_x + c1_hb_y;
  _SFD_EML_CALL(0, 175);
  c1_n_a = c1_psi_d;
  c1_ib_y = c1_n_a * 1.0346864809057312;
  c1_vy_lf = c1_v_y + c1_ib_y;
  ...
  c1_lb_x = c1_kb_x;
  c1_kb_y = c1_lb_x / 2.0;
  c1_vx_rf = c1_v_x - c1_kb_y;
  _SFD_EML_CALL(0, 179);
  c1_p_a = c1_psi_d;
  c1_lb_y = c1_p_a * 1.0346864809057312;
  c1_vy_rf = c1_v_y + c1_lb_y;
  ...
  c1_ob_x = c1_nb_x;
  c1_nb_y = c1_ob_x / 2.0;
  c1_vx_lr = c1_v_x + c1_nb_y;
  _SFD_EML_CALL(0, 183);
  c1_r_a = c1_psi_d;
  c1_ob_y = c1_r_a * 1.6553135190942689;
  c1_vy_lr = c1_v_y - c1_ob_y;
  ...
  c1_rb_x = c1_qb_x;
  c1_qb_y = c1_rb_x / 2.0;
  c1_vx_rr = c1_v_x - c1_qb_y;
  _SFD_EML_CALL(0, 187);
  c1_t_a = c1_psi_d;
  c1_rb_y = c1_t_a * 1.6553135190942689;
  c1_vy_rr = c1_v_y - c1_rb_y;
  ...
  c1_v_a = c1_vx_lf;
  c1_kb_b = c1_wb_x;
  c1_tb_y = c1_v_a * c1_kb_b;
  c1_vc_lf = c1_sb_y - c1_tb_y;
  _SFD_EML_CALL(0, 212);
  c1_yb_x = c1_delta;
  c1_ac_x = c1_yb_x;
  c1_bc_x = c1_ac_x;
  ...
  c1_x_a = c1_vx_rf;
  c1_mb_b = c1_dc_x;
  c1_vb_y = c1_x_a * c1_mb_b;
  c1_vc_rf = c1_ub_y - c1_vb_y;
  _SFD_EML_CALL(0, 213);
  c1_vc_lr = c1_vy_lr;
  _SFD_EML_CALL(0, 214);
  c1_vc_rr = c1_vy_rr;
  ...
  c1_ab_a = c1_vx_lf;
  c1_ob_b = c1_jc_x;
  c1_xb_y = c1_ab_a * c1_ob_b;
  c1_vl_lf = c1_wb_y + c1_xb_y;
  _SFD_EML_CALL(0, 217);
  c1_lc_x = c1_delta;
  c1_mc_x = c1_lc_x;
  c1_nc_x = c1_mc_x;
  ...
  c1_cb_a = c1_vx_rf;
  c1_qb_b = c1_pc_x;
  c1_ac_y = c1_cb_a * c1_qb_b;
  c1_vl_rf = c1_yb_y + c1_ac_y;
  _SFD_EML_CALL(0, 218);
  c1_vl_lr = c1_vx_lr;
  _SFD_EML_CALL(0, 219);
  c1_vl_rr = c1_vx_rr;
  ...
  _SFD_EML_CALL(0, 233);
  c1_rb_b = c1_Fzlf;
  c1_C_alf = 5.0 * c1_rb_b;
  _SFD_EML_CALL(0, 234);
  c1_sb_b = c1_Fzrf;
  c1_C_arf = 5.0 * c1_sb_b;
  _SFD_EML_CALL(0, 235);
  c1_tb_b = c1_Fzlr;
  c1_C_alr = 5.0 * c1_tb_b;
  _SFD_EML_CALL(0, 236);
  c1_ub_b = c1_Fzrr;
  c1_C_arr = 5.0 * c1_ub_b;
  _SFD_EML_CALL(0, 238);
  c1_Fxtlf = 0.0;
  _SFD_EML_CALL(0, 239);
  c1_Fxtrf = 0.0;
  ...
  c1_db_a = -c1_a_lf;
  c1_vb_b = c1_C_alf;
  c1_Fytlf = c1_db_a * c1_vb_b;
  _SFD_EML_CALL(0, 244);
  c1_eb_a = -c1_a_rf;
  c1_wb_b = c1_C_arf;
  c1_Fytrf = c1_eb_a * c1_wb_b;
  _SFD_EML_CALL(0, 245);
  c1_fb_a = -c1_a_lr;
  c1_xb_b = c1_C_alr;
  c1_Fytlr = c1_fb_a * c1_xb_b;
  _SFD_EML_CALL(0, 246);
  c1_gb_a = -c1_a_rr;
  c1_yb_b = c1_C_arr;
  c1_Fytrr = c1_gb_a * c1_yb_b;
  _SFD_EML_CALL(0, 248);
  c1_md_x = c1_delta;
  c1_nd_x = c1_md_x;
  c1_od_x = c1_nd_x;
  ...
  c1_hb_a = c1_Fytlf;
  c1_bc_b = c1_qd_x;
  c1_sc_y = c1_hb_a * c1_bc_b;
  c1_Fxlf = c1_rc_y - c1_sc_y;
  _SFD_EML_CALL(0, 249);
  c1_sd_x = c1_delta;
  c1_td_x = c1_sd_x;
  c1_ud_x = c1_td_x;
  c1_td_x = c1_ud_x;
  c1_td_x = muDoubleScalarCos(c1_td_x);
  c1_cc_b = c1_td_x;
  c1_tc_y = 0.0 * c1_cc_b;
  c1_vd_x = c1_delta;
  c1_wd_x = c1_vd_x;
  ...
  c1_ib_a = c1_Fytrf;
  c1_dc_b = c1_wd_x;
  c1_uc_y = c1_ib_a * c1_dc_b;
  c1_Fxrf = c1_tc_y - c1_uc_y;
  _SFD_EML_CALL(0, 250);
  c1_Fxlr = 0.0;
  _SFD_EML_CALL(0, 251);
  c1_Fxrr = 0.0;
  ...
  _SFD_EML_CALL(0, 268);
  c1_ic_b = c1_phi;
  c1_ad_y = -47298.369313023613 * c1_ic_b;
  c1_jc_b = c1_phi_d;
  c1_bd_y = 2717.2476562 * c1_jc_b;
  c1_T_phif = c1_ad_y - c1_bd_y;
  _SFD_EML_CALL(0, 269);
  c1_kc_b = c1_phi;
  c1_cd_y = -37310.859108305551 * c1_kc_b;
  c1_lc_b = c1_phi_d;
  c1_dd_y = 2895.6587717249995 * c1_lc_b;
  c1_T_phir = c1_cd_y - c1_dd_y;
  ...
  c1_mc_b = c1_me_x;
  c1_ed_y = 6673.7516684110269 * c1_mc_b;
  c1_nc_b = c1_a_sy;
  c1_fd_y = 680.300883630074 * c1_nc_b;
  c1_oe_x = c1_phi;
  c1_pe_x = c1_oe_x;
  c1_qe_x = c1_pe_x;
  c1_pe_x = c1_qe_x;
  ...
  c1_lb_a = c1_fd_y;
  c1_oc_b = c1_pe_x;
  c1_gd_y = c1_lb_a * c1_oc_b;
  c1_sigTxs = ((c1_T_phif + c1_T_phir) - c1_ed_y) + c1_gd_y;
  _SFD_EML_CALL(0, 279);
  c1_mb_a = c1_Fylf + c1_Fyrf;
  c1_hd_y = c1_mb_a * 1.0346864809057312;
  c1_nb_a = c1_Fylr + c1_Fyrr;
  c1_id_y = c1_nb_a * 1.6553135190942689;
  c1_pc_b = c1_Fxlf - c1_Fxrf;
  c1_jd_y = 0.77 * c1_pc_b;
  c1_sigTz = (((((c1_hd_y - c1_id_y) + c1_jd_y) + c1_Mzlf) + c1_Mzrf) + c1_Mzlr)
    + c1_Mzrr;
  ...
  /*  Dm1 = M_s*h_s/I_zzo; */
  /*  Dm2 = (I_xzs+M_s*h_s*l_cgs)/I_zzo; */
  /*   */
  /*  Mass_Matrix =   [1            0 0               Am*sin(phi) */
  /*                   0            1 Bm*cos(phi)     0 */
  /*                   0            0	1               Cm*cos(phi) */
  /*                   Dm1*sin(phi) 0	Dm2*cos(phi)    1]; */
  /*   */
  ...
  /*  B3 = -M_s*h_s*(1/M); */
  /*  B4 = M_s*h_s*(1/M); */
  /*  C1 = 1/(I_xxs+M_s*h_s^2); */
  /*  C2 = (I_xzs+M_s*h_s*l_cgs)/(I_xxs+M_s*h_s^2); */
  /*  C3 = (I_zzs - I_yys - M_s*h_s^2)/(I_xxs+M_s*h_s^2); */
  /*  D1 = (1/I_zzo); */
  /*  D2 = -(I_xzs+M_s*h_s*l_cgs)/I_zzo; */
  /*  D3 = (I_zzs - I_yys - M_s*h_s^2)/I_zzo; */
  /*   */
  /*  F_c = zeros(4,1);              */
  /*   */
  /*  F_c(1) = A1*psi_d*v_y   + A2*sigFx                  + A3*phi_d*psi_d*cos(phi); */
  /*  F_c(2) = B1*psi_d*v_x   + B2*sigFy                  + B3*phi_d^2*sin(phi)               + B4*psi_d^2*sin(phi); */
  /*  F_c(3) = C1*sigTxs      + C2*sin(phi)*phi_d*psi_d   + C3*sin(phi)*cos(phi)*psi_d^2; */
  /*  F_c(4) = D1*sigTz       + D2*sin(phi)*phi_d^2       + D3*sin(phi)*cos(phi)*psi_d*phi_d; */
  /*   */
  /*  % decouple the EoM */
  ...
  _SFD_EML_CALL(0, 368);
  c1_Cm = 0.028355579364616707;
  _SFD_EML_CALL(0, 369);
  c1_e_B = c1_I_zzo;
  c1_kd_y = c1_e_B;
  c1_ld_y = c1_kd_y;
  c1_md_y = c1_ld_y;
  c1_Dm1 = 680.300883630074 / c1_md_y;
  _SFD_EML_CALL(0, 370);
  c1_f_B = c1_I_zzo;
  c1_nd_y = c1_f_B;
  c1_od_y = c1_nd_y;
  c1_pd_y = c1_od_y;
  c1_Dm2 = 21.096972567806741 / c1_pd_y;
  _SFD_EML_CALL(0, 372);
  c1_re_x = c1_phi;
  c1_se_x = c1_re_x;
  c1_te_x = c1_se_x;
  ...
  c1_qc_b = c1_se_x;
  c1_qd_y = 0.39907366905031622 * c1_qc_b;
  c1_ue_x = c1_phi;
  c1_ve_x = c1_ue_x;
  c1_we_x = c1_ve_x;
  c1_ve_x = c1_we_x;
  ...
  c1_rc_b = c1_ve_x;
  c1_rd_y = -0.39907366905031622 * c1_rc_b;
  c1_xe_x = c1_phi;
  c1_ye_x = c1_xe_x;
  c1_af_x = c1_ye_x;
  c1_ye_x = c1_af_x;
  ...
  c1_sc_b = c1_ye_x;
  c1_sd_y = 0.028355579364616707 * c1_sc_b;
  c1_bf_x = c1_phi;
  c1_cf_x = c1_bf_x;
  c1_df_x = c1_cf_x;
  c1_cf_x = c1_df_x;
  ...
  c1_ob_a = c1_Dm1;
  c1_tc_b = c1_cf_x;
  c1_td_y = c1_ob_a * c1_tc_b;
  c1_ef_x = c1_phi;
  c1_ff_x = c1_ef_x;
  c1_gf_x = c1_ff_x;
  c1_ff_x = c1_gf_x;
  c1_ff_x = muDoubleScalarCos(c1_ff_x);
  c1_pb_a = c1_Dm2;
  c1_uc_b = c1_ff_x;
  c1_ud_y = c1_pb_a * c1_uc_b;
  c1_Mass_Matrix[0] = 1.0;
  c1_Mass_Matrix[4] = 0.0;
  c1_Mass_Matrix[8] = 0.0;
  c1_Mass_Matrix[12] = c1_qd_y;
  c1_Mass_Matrix[1] = 0.0;
  c1_Mass_Matrix[5] = 1.0;
  c1_Mass_Matrix[9] = c1_rd_y;
  c1_Mass_Matrix[13] = 0.0;
  c1_Mass_Matrix[2] = 0.0;
  c1_Mass_Matrix[6] = 0.0;
  c1_Mass_Matrix[10] = 1.0;
  c1_Mass_Matrix[14] = c1_sd_y;
  c1_Mass_Matrix[3] = c1_td_y;
  c1_Mass_Matrix[7] = 0.0;
  c1_Mass_Matrix[11] = c1_ud_y;
  ...
  c1_ae_y = c1_yd_y;
  c1_be_y = c1_ae_y;
  c1_D2 = -21.096972567806741 / c1_be_y;
  _SFD_EML_CALL(0, 390);
  c1_i_B = c1_I_zzo;
  c1_ce_y = c1_i_B;
  c1_de_y = c1_ce_y;
  c1_ee_y = c1_de_y;
  c1_D3 = -182.72386552351787 / c1_ee_y;
  _SFD_EML_CALL(0, 392);
  ...
  c1_qb_a = c1_fe_y;
  c1_wc_b = c1_v_y;
  c1_ge_y = c1_qb_a * c1_wc_b;
  c1_xc_b = c1_sigFx;
  c1_he_y = 0.000586613480377779 * c1_xc_b;
  c1_yc_b = c1_phi_d;
  c1_ie_y = -0.79814733810063243 * c1_yc_b;
  c1_rb_a = c1_ie_y;
  c1_ad_b = c1_psi_d;
  c1_je_y = c1_rb_a * c1_ad_b;
  c1_hf_x = c1_phi;
  c1_if_x = c1_hf_x;
  c1_jf_x = c1_if_x;
  c1_if_x = c1_jf_x;
  ...
  c1_sb_a = c1_je_y;
  c1_bd_b = c1_if_x;
  c1_ke_y = c1_sb_a * c1_bd_b;
  c1_F_c[0] = (c1_ge_y + c1_he_y) + c1_ke_y;
  _SFD_EML_CALL(0, 395);
  c1_cd_b = c1_psi_d;
  c1_le_y = 0.0 * c1_cd_b;
  c1_tb_a = c1_le_y;
  c1_dd_b = c1_v_x;
  c1_me_y = c1_tb_a * c1_dd_b;
  c1_ed_b = c1_sigFy;
  c1_ne_y = 0.000586613480377779 * c1_ed_b;
  c1_fd_b = c1_mpower(chartInstance, c1_phi_d);
  c1_oe_y = -0.39907366905031622 * c1_fd_b;
  c1_kf_x = c1_phi;
  c1_lf_x = c1_kf_x;
  c1_mf_x = c1_lf_x;
  c1_lf_x = c1_mf_x;
  ...
  c1_ub_a = c1_oe_y;
  c1_gd_b = c1_lf_x;
  c1_pe_y = c1_ub_a * c1_gd_b;
  c1_hd_b = c1_mpower(chartInstance, c1_psi_d);
  c1_qe_y = 0.39907366905031622 * c1_hd_b;
  c1_nf_x = c1_phi;
  c1_of_x = c1_nf_x;
  c1_pf_x = c1_of_x;
  c1_of_x = c1_pf_x;
  ...
  c1_vb_a = c1_qe_y;
  c1_id_b = c1_of_x;
  c1_re_y = c1_vb_a * c1_id_b;
  c1_F_c[1] = ((c1_me_y + c1_ne_y) + c1_pe_y) + c1_re_y;
  _SFD_EML_CALL(0, 396);
  c1_jd_b = c1_sigTxs;
  c1_se_y = 0.0013440591664742624 * c1_jd_b;
  c1_qf_x = c1_phi;
  c1_rf_x = c1_qf_x;
  c1_sf_x = c1_rf_x;
  c1_rf_x = c1_sf_x;
  c1_rf_x = muDoubleScalarSin(c1_rf_x);
  c1_kd_b = c1_rf_x;
  c1_te_y = 0.028355579364616707 * c1_kd_b;
  c1_wb_a = c1_te_y;
  c1_ld_b = c1_phi_d;
  c1_ue_y = c1_wb_a * c1_ld_b;
  c1_xb_a = c1_ue_y;
  c1_md_b = c1_psi_d;
  c1_ve_y = c1_xb_a * c1_md_b;
  c1_tf_x = c1_phi;
  c1_uf_x = c1_tf_x;
  c1_vf_x = c1_uf_x;
  c1_uf_x = c1_vf_x;
  ...
  c1_nd_b = c1_uf_x;
  c1_we_y = -0.24559168639049464 * c1_nd_b;
  c1_wf_x = c1_phi;
  c1_xf_x = c1_wf_x;
  c1_yf_x = c1_xf_x;
  c1_xf_x = c1_yf_x;
  ...
  c1_yb_a = c1_we_y;
  c1_od_b = c1_xf_x;
  c1_xe_y = c1_yb_a * c1_od_b;
  c1_ac_a = c1_xe_y;
  c1_pd_b = c1_mpower(chartInstance, c1_psi_d);
  c1_ye_y = c1_ac_a * c1_pd_b;
  c1_F_c[2] = (c1_se_y + c1_ve_y) + c1_ye_y;
  _SFD_EML_CALL(0, 397);
  c1_bc_a = c1_D1;
  c1_qd_b = c1_sigTz;
  c1_af_y = c1_bc_a * c1_qd_b;
  c1_ag_x = c1_phi;
  c1_bg_x = c1_ag_x;
  c1_cg_x = c1_bg_x;
  c1_bg_x = c1_cg_x;
  ...
  c1_cc_a = c1_D2;
  c1_rd_b = c1_bg_x;
  c1_bf_y = c1_cc_a * c1_rd_b;
  c1_dc_a = c1_bf_y;
  c1_sd_b = c1_mpower(chartInstance, c1_phi_d);
  c1_cf_y = c1_dc_a * c1_sd_b;
  c1_dg_x = c1_phi;
  c1_eg_x = c1_dg_x;
  c1_fg_x = c1_eg_x;
  c1_eg_x = c1_fg_x;
  ...
  c1_fc_a = c1_df_y;
  c1_ud_b = c1_hg_x;
  c1_ef_y = c1_fc_a * c1_ud_b;
  c1_gc_a = c1_ef_y;
  c1_vd_b = c1_psi_d;
  c1_ff_y = c1_gc_a * c1_vd_b;
  c1_hc_a = c1_ff_y;
  c1_wd_b = c1_phi_d;
  c1_gf_y = c1_hc_a * c1_wd_b;
  c1_F_c[3] = (c1_af_y + c1_cf_y) + c1_gf_y;

  /*  decouple the EoM */
  _SFD_EML_CALL(0, 400);
  for (c1_i42 = 0; c1_i42 < 16; c1_i42 = c1_i42 + 1) {
    c1_b_Mass_Matrix[c1_i42] = c1_Mass_Matrix[c1_i42];
  }

  c1_b_mpower(chartInstance, c1_b_Mass_Matrix, c1_ic_a);
  for (c1_i43 = 0; c1_i43 < 4; c1_i43 = c1_i43 + 1) {
    c1_xd_b[c1_i43] = c1_F_c[c1_i43];
  }

  c1_e_eml_scalar_eg(chartInstance);
  c1_e_eml_scalar_eg(chartInstance);
  for (c1_i44 = 0; c1_i44 < 16; c1_i44 = c1_i44 + 1) {
    c1_k_A[c1_i44] = c1_ic_a[c1_i44];
  }

  for (c1_i45 = 0; c1_i45 < 4; c1_i45 = c1_i45 + 1) {
    c1_j_B[c1_i45] = c1_xd_b[c1_i45];
  }
  ...
  for (c1_i47 = 0; c1_i47 < 16; c1_i47 = c1_i47 + 1) {
    c1_l_A[c1_i47] = c1_k_A[c1_i47];
  }

  for (c1_i48 = 0; c1_i48 < 4; c1_i48 = c1_i48 + 1) {
    c1_k_B[c1_i48] = c1_j_B[c1_i48];
  }

  for (c1_i49 = 0; c1_i49 < 16; c1_i49 = c1_i49 + 1) {
    c1_m_A[c1_i49] = c1_l_A[c1_i49];
  }

  for (c1_i50 = 0; c1_i50 < 4; c1_i50 = c1_i50 + 1) {
    c1_l_B[c1_i50] = c1_k_B[c1_i50];
  }
  ...
  for (c1_i51 = 0; c1_i51 < 4; c1_i51 = c1_i51 + 1) {
    ...
    for (c1_i53 = 0; c1_i53 < 4; c1_i53 = c1_i53 + 1) {
      c1_F_u[c1_i51] = c1_F_u[c1_i51] + c1_m_A[c1_i52 + c1_i51] * c1_l_B[c1_i53];
      c1_i52 = c1_i52 + 4;
    }
  }
  ...
  for (c1_i54 = 0; c1_i54 < 6; c1_i54 = c1_i54 + 1) {
    (*c1_b_pdot)[c1_i54] = c1_pdot[c1_i54];
  }

  for (c1_i55 = 0; c1_i55 < 4; c1_i55 = c1_i55 + 1) {
    (*c1_b_slp_ang)[c1_i55] = c1_slp_ang[c1_i55];
  }

  for (c1_i56 = 0; c1_i56 < 5; c1_i56 = c1_i56 + 1) {
    (*c1_b_acc_out)[c1_i56] = c1_acc_out[c1_i56];
  }

  for (c1_i57 = 0; c1_i57 < 4; c1_i57 = c1_i57 + 1) {
    (*c1_b_Fout)[c1_i57] = c1_Fout[c1_i57];
  }
...
static void c1_eml_error(SFc1_DVM_Nikola_testInstanceStruct *chartInstance)
{
  ...
  char_T c1_b_u[102];
  const mxArray *c1_b_y = NULL;
  for (c1_i58 = 0; c1_i58 < 32; c1_i58 = c1_i58 + 1) {
    c1_u[c1_i58] = c1_cv0[c1_i58];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 10, 0U, 1U, 0U, 2, 1, 32));
  for (c1_i59 = 0; c1_i59 < 102; c1_i59 = c1_i59 + 1) {
    c1_b_u[c1_i59] = c1_cv1[c1_i59];
  }
  ...
  c1_b_C[9])
{
  ...
  for (c1_i61 = 0; c1_i61 < 9; c1_i61 = c1_i61 + 1) {
    c1_b_B[c1_i61] = c1_B[c1_i61];
  }

  for (c1_i62 = 0; c1_i62 < 9; c1_i62 = c1_i62 + 1) {
    c1_c_A[c1_i62] = c1_b_A[c1_i62];
  }

  for (c1_i63 = 0; c1_i63 < 9; c1_i63 = c1_i63 + 1) {
    c1_c_B[c1_i63] = c1_b_B[c1_i63];
  }

  for (c1_i64 = 0; c1_i64 < 3; c1_i64 = c1_i64 + 1) {
    c1_i65 = 0;
    for (c1_i66 = 0; c1_i66 < 3; c1_i66 = c1_i66 + 1) {
      c1_b_C[c1_i65 + c1_i64] = 0.0;
      c1_i67 = 0;
      for (c1_i68 = 0; c1_i68 < 3; c1_i68 = c1_i68 + 1) {
        c1_b_C[c1_i65 + c1_i64] = c1_b_C[c1_i65 + c1_i64] + c1_c_A[c1_i67 +
          c1_i64] * c1_c_B[c1_i68 + c1_i65];
        c1_i67 = c1_i67 + 3;
      }
...
static void c1_matrix_to_integer_power(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, real_T c1_a[16], real_T c1_b, real_T c1_c[
  16])
{
  real_T c1_x;
  real_T c1_e;
   ...
   label_1:
    ...
    if (c1_y != c1_e) {
      if (c1_firstmult) {
        for (c1_i70 = 0; c1_i70 < 16; c1_i70 = c1_i70 + 1) {
          c1_c[c1_i70] = c1_a[c1_i70];
        }

        c1_firstmult = FALSE;
      } else {
        for (c1_i71 = 0; c1_i71 < 16; c1_i71 = c1_i71 + 1) {
          c1_b_a[c1_i71] = c1_c[c1_i71];
        }

        for (c1_i72 = 0; c1_i72 < 16; c1_i72 = c1_i72 + 1) {
          c1_c_b[c1_i72] = c1_a[c1_i72];
        }

        c1_d_eml_scalar_eg(chartInstance);
        c1_d_eml_scalar_eg(chartInstance);
        for (c1_i73 = 0; c1_i73 < 16; c1_i73 = c1_i73 + 1) {
          c1_A[c1_i73] = c1_b_a[c1_i73];
        }

        for (c1_i74 = 0; c1_i74 < 16; c1_i74 = c1_i74 + 1) {
          c1_B[c1_i74] = c1_c_b[c1_i74];
        }
        ...
        for (c1_i79 = 0; c1_i79 < 4; c1_i79 = c1_i79 + 1) {
          ...
          for (c1_i81 = 0; c1_i81 < 4; c1_i81 = c1_i81 + 1) {
            c1_c[c1_i80 + c1_i79] = 0.0;
            c1_i82 = 0;
            for (c1_i83 = 0; c1_i83 < 4; c1_i83 = c1_i83 + 1) {
              c1_c[c1_i80 + c1_i79] = c1_c[c1_i80 + c1_i79] + c1_c_A[c1_i82 +
                c1_i79] * c1_c_B[c1_i83 + c1_i80];
              c1_i82 = c1_i82 + 4;
            }
    ...
    if (c1_ed2 == 0.0) {
      ...
      for (c1_i90 = 0; c1_i90 < 16; c1_i90 = c1_i90 + 1) {
        c1_d_a[c1_i90] = c1_a[c1_i90];
      }

      for (c1_i91 = 0; c1_i91 < 16; c1_i91 = c1_i91 + 1) {
        c1_f_b[c1_i91] = c1_a[c1_i91];
      }

      c1_d_eml_scalar_eg(chartInstance);
      c1_d_eml_scalar_eg(chartInstance);
      for (c1_i92 = 0; c1_i92 < 16; c1_i92 = c1_i92 + 1) {
        c1_d_A[c1_i92] = c1_d_a[c1_i92];
      }

      for (c1_i93 = 0; c1_i93 < 16; c1_i93 = c1_i93 + 1) {
        c1_d_B[c1_i93] = c1_f_b[c1_i93];
      }

      for (c1_i94 = 0; c1_i94 < 16; c1_i94 = c1_i94 + 1) {
        c1_e_A[c1_i94] = c1_d_A[c1_i94];
      }

      for (c1_i95 = 0; c1_i95 < 16; c1_i95 = c1_i95 + 1) {
        c1_e_B[c1_i95] = c1_d_B[c1_i95];
      }

      for (c1_i96 = 0; c1_i96 < 16; c1_i96 = c1_i96 + 1) {
        c1_f_A[c1_i96] = c1_e_A[c1_i96];
      }

      for (c1_i97 = 0; c1_i97 < 16; c1_i97 = c1_i97 + 1) {
        c1_f_B[c1_i97] = c1_e_B[c1_i97];
      }

      for (c1_i98 = 0; c1_i98 < 4; c1_i98 = c1_i98 + 1) {
        c1_i99 = 0;
        for (c1_i100 = 0; c1_i100 < 4; c1_i100 = c1_i100 + 1) {
          c1_a[c1_i99 + c1_i98] = 0.0;
          c1_i101 = 0;
          for (c1_i102 = 0; c1_i102 < 4; c1_i102 = c1_i102 + 1) {
            c1_a[c1_i99 + c1_i98] = c1_a[c1_i99 + c1_i98] + c1_f_A[c1_i101 +
              c1_i98] * c1_f_B[c1_i102 + c1_i99];
            c1_i101 = c1_i101 + 4;
          }
                      ...
                      c1_x[16], real_T c1_y[16])
{
  ...
  for (c1_i105 = 0; c1_i105 < 16; c1_i105 = c1_i105 + 1) {
    c1_A[c1_i105] = c1_x[c1_i105];
  }

  for (c1_i106 = 0; c1_i106 < 16; c1_i106 = c1_i106 + 1) {
    c1_b_x[c1_i106] = c1_A[c1_i106];
  }

  for (c1_i107 = 0; c1_i107 < 16; c1_i107 = c1_i107 + 1) {
    c1_b_A[c1_i107] = c1_b_x[c1_i107];
  }

  for (c1_i108 = 0; c1_i108 < 16; c1_i108 = c1_i108 + 1) {
    c1_c_A[c1_i108] = c1_b_A[c1_i108];
  }

  for (c1_i109 = 0; c1_i109 < 16; c1_i109 = c1_i109 + 1) {
    c1_d_A[c1_i109] = c1_c_A[c1_i109];
  }

  c1_eml_matlab_zgetrf(chartInstance, c1_d_A, c1_e_A, c1_ipiv, &c1_info);
  for (c1_i110 = 0; c1_i110 < 16; c1_i110 = c1_i110 + 1) {
    c1_c_A[c1_i110] = c1_e_A[c1_i110];
  }

  for (c1_i111 = 0; c1_i111 < 4; c1_i111 = c1_i111 + 1) {
    c1_b_ipiv[c1_i111] = c1_ipiv[c1_i111];
  }

  for (c1_i112 = 0; c1_i112 < 16; c1_i112 = c1_i112 + 1) {
    c1_b_x[c1_i112] = c1_c_A[c1_i112];
  }

  for (c1_i113 = 0; c1_i113 < 4; c1_i113 = c1_i113 + 1) {
    c1_c_ipiv[c1_i113] = c1_b_ipiv[c1_i113];
  }

  for (c1_i114 = 0; c1_i114 < 16; c1_i114 = c1_i114 + 1) {
    c1_x[c1_i114] = c1_b_x[c1_i114];
  }

  for (c1_i115 = 0; c1_i115 < 4; c1_i115 = c1_i115 + 1) {
    c1_d_ipiv[c1_i115] = c1_c_ipiv[c1_i115];
  }

  for (c1_i116 = 0; c1_i116 < 4; c1_i116 = c1_i116 + 1) {
    c1_e_ipiv[c1_i116] = c1_d_ipiv[c1_i116];
  }

  for (c1_i117 = 0; c1_i117 < 4; c1_i117 = c1_i117 + 1) {
    c1_p[c1_i117] = 1 + c1_i117;
  }
  ...
  for (c1_c_k = 1; c1_c_k < 5; c1_c_k = c1_c_k + 1) {
    ...
    for (c1_j = c1_e_k; c1_j < 5; c1_j = c1_j + 1) {
      ...
      if (c1_y[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        ...
        c1_a = c1_b_j;
        c1_i118 = c1_a + 1;
        for (c1_i = c1_i118; c1_i < 5; c1_i = c1_i + 1) {
          c1_b_i = c1_i;
  ...
  for (c1_i119 = 0; c1_i119 < 16; c1_i119 = c1_i119 + 1) {
    c1_f_A[c1_i119] = c1_x[c1_i119];
  }

  for (c1_i120 = 0; c1_i120 < 16; c1_i120 = c1_i120 + 1) {
    c1_B[c1_i120] = c1_y[c1_i120];
  }

  for (c1_i121 = 0; c1_i121 < 16; c1_i121 = c1_i121 + 1) {
    c1_y[c1_i121] = c1_B[c1_i121];
  }

  for (c1_i122 = 0; c1_i122 < 16; c1_i122 = c1_i122 + 1) {
    c1_g_A[c1_i122] = c1_f_A[c1_i122];
  }

  for (c1_i123 = 0; c1_i123 < 16; c1_i123 = c1_i123 + 1) {
    c1_c_y[c1_i123] = c1_y[c1_i123];
  }
  ...
  c1_ipiv[4], int32_T *c1_info)
{
  ...
  for (c1_i124 = 0; c1_i124 < 16; c1_i124 = c1_i124 + 1) {
    c1_b_A[c1_i124] = c1_A[c1_i124];
  }

  c1_eps(chartInstance);
  for (c1_i125 = 0; c1_i125 < 4; c1_i125 = c1_i125 + 1) {
    c1_ipiv[c1_i125] = 1 + c1_i125;
  }
  ...
  *c1_info = 0;
  for (c1_j = 1; c1_j < 4; c1_j = c1_j + 1) {
    ...
    for (c1_i134 = 0; c1_i134 < 16; c1_i134 = c1_i134 + 1) {
      c1_d_A[c1_i134] = c1_b_A[c1_i134];
    }

    c1_ia0 = c1_g_c;
    for (c1_i135 = 0; c1_i135 < 16; c1_i135 = c1_i135 + 1) {
      c1_b_A[c1_i135] = c1_d_A[c1_i135];
    }
    ...
    for (c1_i136 = 0; c1_i136 < 16; c1_i136 = c1_i136 + 1) {
      c1_e_A[c1_i136] = c1_b_A[c1_i136];
    }

    c1_b_ia0 = c1_ia0;
    for (c1_i137 = 0; c1_i137 < 16; c1_i137 = c1_i137 + 1) {
      c1_b_A[c1_i137] = c1_e_A[c1_i137];
    }
    ...
    for (c1_i138 = 0; c1_i138 < 16; c1_i138 = c1_i138 + 1) {
      c1_f_A[c1_i138] = c1_b_A[c1_i138];
    }

    c1_c_ia0 = c1_b_ia0;
    for (c1_i139 = 0; c1_i139 < 16; c1_i139 = c1_i139 + 1) {
      c1_b_A[c1_i139] = c1_f_A[c1_i139];
    }
  ...
  c1_ib0, int32_T c1_ldb, real_T c1_b_B[16])
{
  ...
  for (c1_i145 = 0; c1_i145 < 16; c1_i145 = c1_i145 + 1) {
    c1_b_B[c1_i145] = c1_B[c1_i145];
  }

  c1_b_m = c1_m;
  c1_b_n = c1_n;
  c1_b_alpha1 = c1_alpha1;
  for (c1_i146 = 0; c1_i146 < 16; c1_i146 = c1_i146 + 1) {
    c1_b_A[c1_i146] = c1_A[c1_i146];
  }

  c1_b_ia0 = c1_ia0;
  c1_b_lda = c1_lda;
  for (c1_i147 = 0; c1_i147 < 16; c1_i147 = c1_i147 + 1) {
    c1_c_B[c1_i147] = c1_b_B[c1_i147];
  }

  c1_b_ib0 = c1_ib0;
  c1_b_ldb = c1_ldb;
  for (c1_i148 = 0; c1_i148 < 16; c1_i148 = c1_i148 + 1) {
    c1_b_B[c1_i148] = c1_c_B[c1_i148];
  }
                      ...
                      c1_x[16])
{
  ...
  real_T c1_e_x;
  boolean_T c1_b;
  for (c1_i149 = 0; c1_i149 < 16; c1_i149 = c1_i149 + 1) {
    c1_b_x[c1_i149] = c1_x[c1_i149];
  }
...
static void c1_eml_warning(SFc1_DVM_Nikola_testInstanceStruct *chartInstance)
{
  ...
  char_T c1_b_u[40];
  const mxArray *c1_b_y = NULL;
  for (c1_i150 = 0; c1_i150 < 21; c1_i150 = c1_i150 + 1) {
    c1_u[c1_i150] = c1_cv2[c1_i150];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 10, 0U, 1U, 0U, 2, 1, 21));
  for (c1_i151 = 0; c1_i151 < 40; c1_i151 = c1_i151 + 1) {
    c1_b_u[c1_i151] = c1_cv3[c1_i151];
  }
  ...
  real_T c1_varargin_3)
{
  ...
  real_T c1_c_u;
  const mxArray *c1_c_y = NULL;
  for (c1_i152 = 0; c1_i152 < 27; c1_i152 = c1_i152 + 1) {
    c1_u[c1_i152] = c1_cv4[c1_i152];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_u, 10, 0U, 1U, 0U, 2, 1, 27));
  for (c1_i153 = 0; c1_i153 < 103; c1_i153 = c1_i153 + 1) {
    c1_b_u[c1_i153] = c1_cv5[c1_i153];
  }
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_DVM_Nikola_testInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Nikola_testInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i154 = 0; c1_i154 < 4; c1_i154 = c1_i154 + 1) {
    c1_b_u[c1_i154] = (*((real_T (*)[4])c1_u))[c1_i154];
  }

  for (c1_i155 = 0; c1_i155 < 4; c1_i155 = c1_i155 + 1) {
    c1_c_u[c1_i155] = c1_b_u[c1_i155];
  }
...
static const mxArray *c1_b_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Nikola_testInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i156 = 0; c1_i156 < 5; c1_i156 = c1_i156 + 1) {
    c1_b_u[c1_i156] = (*((real_T (*)[5])c1_u))[c1_i156];
  }

  for (c1_i157 = 0; c1_i157 < 5; c1_i157 = c1_i157 + 1) {
    c1_c_u[c1_i157] = c1_b_u[c1_i157];
  }
...
static const mxArray *c1_c_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Nikola_testInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i158 = 0; c1_i158 < 6; c1_i158 = c1_i158 + 1) {
    c1_b_u[c1_i158] = (*((real_T (*)[6])c1_u))[c1_i158];
  }

  for (c1_i159 = 0; c1_i159 < 6; c1_i159 = c1_i159 + 1) {
    c1_c_u[c1_i159] = c1_b_u[c1_i159];
  }
...
static const mxArray *c1_e_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i160 = 0; c1_i160 < 4; c1_i160 = c1_i160 + 1) {
    c1_b_u[c1_i160] = (*((real_T (*)[4])c1_u))[c1_i160];
  }

  for (c1_i161 = 0; c1_i161 < 4; c1_i161 = c1_i161 + 1) {
    c1_c_u[c1_i161] = c1_b_u[c1_i161];
  }
...
static const mxArray *c1_f_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i162 = 0;
  for (c1_i163 = 0; c1_i163 < 4; c1_i163 = c1_i163 + 1) {
    for (c1_i164 = 0; c1_i164 < 4; c1_i164 = c1_i164 + 1) {
      c1_b_u[c1_i164 + c1_i162] = (*((real_T (*)[16])c1_u))[c1_i164 + c1_i162];
    }
  ...
  for (c1_i166 = 0; c1_i166 < 4; c1_i166 = c1_i166 + 1) {
    for (c1_i167 = 0; c1_i167 < 4; c1_i167 = c1_i167 + 1) {
      c1_c_u[c1_i167 + c1_i165] = c1_b_u[c1_i167 + c1_i165];
    }
...
static const mxArray *c1_g_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i168 = 0;
  for (c1_i169 = 0; c1_i169 < 3; c1_i169 = c1_i169 + 1) {
    for (c1_i170 = 0; c1_i170 < 3; c1_i170 = c1_i170 + 1) {
      c1_b_u[c1_i170 + c1_i168] = (*((real_T (*)[9])c1_u))[c1_i170 + c1_i168];
    }
  ...
  c1_i171 = 0;
  for (c1_i172 = 0; c1_i172 < 3; c1_i172 = c1_i172 + 1) {
    for (c1_i173 = 0; c1_i173 < 3; c1_i173 = c1_i173 + 1) {
      c1_c_u[c1_i173 + c1_i171] = c1_b_u[c1_i173 + c1_i171];
    }
...
static const mxArray *c1_h_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i174 = 0;
  for (c1_i175 = 0; c1_i175 < 2; c1_i175 = c1_i175 + 1) {
    for (c1_i176 = 0; c1_i176 < 4; c1_i176 = c1_i176 + 1) {
      c1_b_u[c1_i176 + c1_i174] = (*((real_T (*)[8])c1_u))[c1_i176 + c1_i174];
    }
  ...
  c1_i177 = 0;
  for (c1_i178 = 0; c1_i178 < 2; c1_i178 = c1_i178 + 1) {
    for (c1_i179 = 0; c1_i179 < 4; c1_i179 = c1_i179 + 1) {
      c1_c_u[c1_i179 + c1_i177] = c1_b_u[c1_i179 + c1_i177];
    }
...
static const mxArray *c1_i_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i181 = 0; c1_i181 < 2; c1_i181 = c1_i181 + 1) {
    for (c1_i182 = 0; c1_i182 < 5; c1_i182 = c1_i182 + 1) {
      c1_b_u[c1_i182 + c1_i180] = (*((real_T (*)[10])c1_u))[c1_i182 + c1_i180];
    }
  ...
  for (c1_i184 = 0; c1_i184 < 2; c1_i184 = c1_i184 + 1) {
    for (c1_i185 = 0; c1_i185 < 5; c1_i185 = c1_i185 + 1) {
      c1_c_u[c1_i185 + c1_i183] = c1_b_u[c1_i185 + c1_i183];
    }
...
const mxArray *sf_c1_DVM_Nikola_test_get_eml_resolved_functions_info(void)
{
  ...
  real_T c1_y[4])
{
  real_T c1_dv13[4];
  int32_T c1_i187;
  sf_mex_import(c1_name, sf_mex_dup(c1_Fout), c1_dv13, 1, 0, 0U, 1, 0U, 2, 1, 4);
  for (c1_i187 = 0; c1_i187 < 4; c1_i187 = c1_i187 + 1) {
    c1_y[c1_i187] = c1_dv13[c1_i187];
  }
...
static void c1_b_emlrt_marshallIn(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, const mxArray *c1_acc_out, const char_T *
  c1_name, real_T c1_y[5])
{
  real_T c1_dv14[5];
  int32_T c1_i188;
  sf_mex_import(c1_name, sf_mex_dup(c1_acc_out), c1_dv14, 1, 0, 0U, 1, 0U, 1, 5);
  for (c1_i188 = 0; c1_i188 < 5; c1_i188 = c1_i188 + 1) {
    c1_y[c1_i188] = c1_dv14[c1_i188];
  }
  ...
  real_T c1_y[6])
{
  real_T c1_dv15[6];
  int32_T c1_i189;
  sf_mex_import(c1_name, sf_mex_dup(c1_pdot), c1_dv15, 1, 0, 0U, 1, 0U, 1, 6);
  for (c1_i189 = 0; c1_i189 < 6; c1_i189 = c1_i189 + 1) {
    c1_y[c1_i189] = c1_dv15[c1_i189];
  }
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Nikola_testInstanceStruct
  *chartInstance, const mxArray *
  c1_b_is_active_c1_DVM_Nikola_test, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_DVM_Nikola_test), &c1_u0,
                1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_DVM_Nikola_test);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_DVM_Nikola_test_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(423490183U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3403298034U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3112541267U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(254245627U);
}

mxArray *sf_c1_DVM_Nikola_test_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3996200301U);
    pr[1] = (double)(3659322443U);
    pr[2] = (double)(2292868315U);
    pr[3] = (double)(1665624545U);
...
static mxArray *sf_get_sim_state_info_c1_DVM_Nikola_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[11],T\"Fout\",},{M[1],M[10],T\"acc_out\",},{M[1],M[5],T\"pdot\",},{M[1],M[9],T\"slp_ang\",},{M[8],M[0],T\"is_active_c1_DVM_Nikola_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DVM_Nikola_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_DVM_Nikola_testInstanceStruct *chartInstance;
    chartInstance = (SFc1_DVM_Nikola_testInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_DVM_Nikola_testMachineNumber_,
           1,
           1,
           1,
           8,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_DVM_Nikola_testMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_DVM_Nikola_testMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_DVM_Nikola_testMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,12377);
      ...
      sf_debug_reset_current_state_configuration(_DVM_Nikola_testMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_DVM_Nikola_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DVM_Nikola_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*)
    chartInstanceVar);
  initialize_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_DVM_Nikola_test(void *chartInstanceVar)
{
  enable_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_DVM_Nikola_test(void *chartInstanceVar)
{
  disable_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_DVM_Nikola_test(void *chartInstanceVar)
{
  sf_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_DVM_Nikola_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DVM_Nikola_test
    ((SFc1_DVM_Nikola_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_DVM_Nikola_test();/* state var info */
...
static void sf_internal_set_sim_state_c1_DVM_Nikola_test(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DVM_Nikola_test();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_DVM_Nikola_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DVM_Nikola_test(S);
}

static void sf_opaque_set_sim_state_c1_DVM_Nikola_test(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_DVM_Nikola_test(S, st);
}

static void sf_opaque_terminate_c1_DVM_Nikola_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DVM_Nikola_testInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_DVM_Nikola_test((SFc1_DVM_Nikola_testInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_DVM_Nikola_test
    ((SFc1_DVM_Nikola_testInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DVM_Nikola_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_DVM_Nikola_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DVM_Nikola_test","DVM_Nikola_test",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DVM_Nikola_test","DVM_Nikola_test",1,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DVM_Nikola_test",
      "DVM_Nikola_test",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DVM_Nikola_test","DVM_Nikola_test",
        1,4);
      sf_mark_chart_reusable_outputs(S,"DVM_Nikola_test","DVM_Nikola_test",1,4);
    }

    sf_set_rtw_dwork_info(S,"DVM_Nikola_test","DVM_Nikola_test",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(2331011701U));
  ssSetChecksum1(S,(894270643U));
  ssSetChecksum2(S,(1256656241U));
  ssSetChecksum3(S,(437824457U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_DVM_Nikola_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DVM_Nikola_test", "DVM_Nikola_test",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_DVM_Nikola_test(SimStruct *S)
{
  SFc1_DVM_Nikola_testInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Nikola_testInstanceStruct *)malloc(sizeof
    (SFc1_DVM_Nikola_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DVM_Nikola_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DVM_Nikola_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DVM_Nikola_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DVM_Nikola_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DVM_Nikola_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_DVM_Nikola_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DVM_Nikola_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DVM_Nikola_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DVM_Nikola_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DVM_Nikola_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DVM_Nikola_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DVM_Nikola_test;
...
void c1_DVM_Nikola_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DVM_Nikola_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DVM_Nikola_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DVM_Nikola_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DVM_Nikola_test_method_dispatcher.\n"
