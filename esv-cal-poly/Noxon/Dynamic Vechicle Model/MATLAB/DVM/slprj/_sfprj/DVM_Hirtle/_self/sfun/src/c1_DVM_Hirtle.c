...
static void initialize_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct
  *chartInstance);
static void initialize_params_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct
  *chartInstance);
static void enable_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void disable_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *
  chartInstance);
static void set_sim_state_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void sf_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void c1_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c1_DVM_Hirtle
  (SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static real_T c1_mpower(SFc1_DVM_HirtleInstanceStruct *chartInstance, real_T
  c1_a);
static real_T c1_power(SFc1_DVM_HirtleInstanceStruct *chartInstance, real_T c1_a,
  real_T c1_b);
static void c1_eml_scalar_eg(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void c1_eml_error(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_DVM_HirtleInstanceStruct *chartInstance);
static void c1_eml_xgemm(SFc1_DVM_HirtleInstanceStruct *chartInstance, real_T
  c1_A[9], real_T c1_B[9], real_T c1_C[9], real_T c1_b_C[9]);
static real_T c1_b_mpower(SFc1_DVM_HirtleInstanceStruct *chartInstance, real_T
  c1_a);
...
static void c1_emlrt_marshallIn(SFc1_DVM_HirtleInstanceStruct *chartInstance,
  const mxArray *c1_Fout, const char_T *c1_name, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_DVM_HirtleInstanceStruct *chartInstance,
  const mxArray *c1_acc_out, const char_T *c1_name, real_T c1_y[5]);
static void c1_c_emlrt_marshallIn(SFc1_DVM_HirtleInstanceStruct *chartInstance,
  const mxArray *c1_pdot, const char_T *c1_name, real_T c1_y[10]);
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_HirtleInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_DVM_Hirtle, const char_T
  *c1_name);
static void init_dsm_address_info(SFc1_DVM_HirtleInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Hirtle = 0U;
}
  ...
  chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_DVM_Hirtle;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Hirtle = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_DVM_Hirtle");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DVM_Hirtle(chartInstance);
...
static void sf_c1_DVM_Hirtle(SFc1_DVM_HirtleInstanceStruct *chartInstance)
{
  ...
  c1_c1_DVM_Hirtle(chartInstance);
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_DVM_HirtleInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_HirtleInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
...
const mxArray *sf_c1_DVM_Hirtle_get_eml_resolved_functions_info(void)
{
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_HirtleInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_DVM_Hirtle,
  const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_DVM_Hirtle), &c1_u0, 1, 3,
                0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_DVM_Hirtle);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_DVM_Hirtle_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(619797217U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1985463131U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3245661553U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1807318835U);
}

mxArray *sf_c1_DVM_Hirtle_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(587542329U);
    pr[1] = (double)(3727278305U);
    pr[2] = (double)(3324435757U);
    pr[3] = (double)(4041114003U);
...
static mxArray *sf_get_sim_state_info_c1_DVM_Hirtle(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[11],T\"Fout\",},{M[1],M[10],T\"acc_out\",},{M[1],M[5],T\"pdot\",},{M[1],M[9],T\"slp_ang\",},{M[8],M[0],T\"is_active_c1_DVM_Hirtle\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DVM_Hirtle_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_DVM_HirtleInstanceStruct *chartInstance;
    chartInstance = (SFc1_DVM_HirtleInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,9031);
...
static void sf_opaque_initialize_c1_DVM_Hirtle(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*)
    chartInstanceVar);
  initialize_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DVM_Hirtle(void *chartInstanceVar)
{
  enable_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DVM_Hirtle(void *chartInstanceVar)
{
  disable_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DVM_Hirtle(void *chartInstanceVar)
{
  sf_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_DVM_Hirtle(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DVM_Hirtle
    ((SFc1_DVM_HirtleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_DVM_Hirtle();/* state var info */
...
static void sf_internal_set_sim_state_c1_DVM_Hirtle(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DVM_Hirtle();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_DVM_Hirtle(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DVM_Hirtle(S);
}

static void sf_opaque_set_sim_state_c1_DVM_Hirtle(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_DVM_Hirtle(S, st);
}

static void sf_opaque_terminate_c1_DVM_Hirtle(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_DVM_Hirtle((SFc1_DVM_HirtleInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DVM_Hirtle(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_DVM_Hirtle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DVM_Hirtle","DVM_Hirtle",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DVM_Hirtle","DVM_Hirtle",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DVM_Hirtle",
      "DVM_Hirtle",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DVM_Hirtle","DVM_Hirtle",1,4);
      sf_mark_chart_reusable_outputs(S,"DVM_Hirtle","DVM_Hirtle",1,4);
    }

    sf_set_rtw_dwork_info(S,"DVM_Hirtle","DVM_Hirtle",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(1038356561U));
  ssSetChecksum1(S,(1609118433U));
  ssSetChecksum2(S,(1531024330U));
  ssSetChecksum3(S,(2209709228U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_DVM_Hirtle(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DVM_Hirtle", "DVM_Hirtle",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_DVM_Hirtle(SimStruct *S)
{
  SFc1_DVM_HirtleInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_HirtleInstanceStruct *)malloc(sizeof
    (SFc1_DVM_HirtleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DVM_HirtleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_DVM_Hirtle;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_DVM_Hirtle;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_DVM_Hirtle;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DVM_Hirtle;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_DVM_Hirtle;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_DVM_Hirtle;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_DVM_Hirtle;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_DVM_Hirtle;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DVM_Hirtle;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DVM_Hirtle;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_DVM_Hirtle;
...
void c1_DVM_Hirtle_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DVM_Hirtle(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DVM_Hirtle(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DVM_Hirtle(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DVM_Hirtle_method_dispatcher.\n"
