...
#include "DVM_Hirtle_global_frame_sfun_debug_macros.h"
...
static const char *c1_debug_family_names[185] = { "g", "v_x", "v_y", "phi",
  ...
  "alpha_lr_new", "alpha_rr_new", "T_phif", "T_phir", "sigFx", "sigFy", "sigTxs",
  "sigTz", "x_d", "y_d", "A1", "A2", "A3", "B1", "B2", "B3", "B4", "C1", "C2",
  "C3", "C4", "D1", "D2", "D3", "D4", "D5", "D6", "Mass_Matrix", "F_Ec", "F_Eu",
  "a_x_new", "a_y_new", "phi_dd_new", "psi_dd_new", "nargin", "nargout", "p",
  "steer", "torque", "acc_in", "pdot", "slp_ang", "acc_out", "Fout" };

/* Function Declarations */
static void initialize_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void initialize_params_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void enable_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void disable_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void set_sim_state_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void sf_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void c1_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void compInitSubchartSimstructsFcn_c1_DVM_Hirtle_global_frame
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static real_T c1_mpower(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_a);
static real_T c1_power(SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance,
  real_T c1_a, real_T c1_b);
static void c1_eml_scalar_eg(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
static void c1_eml_error(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
static void c1_eml_xgemm(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_A[9], real_T c1_B[9], real_T c1_C[9], real_T c1_b_C
  [9]);
static real_T c1_b_mpower(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_a);
static void c1_c_mpower(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_a[16], real_T c1_c[16]);
static void c1_matrix_to_integer_power
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance, real_T c1_a[16],
   real_T c1_b, real_T c1_c[16]);
static void c1_c_eml_scalar_eg(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
static void c1_d_eml_scalar_eg(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
static void c1_invNxN(SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance,
                      real_T c1_x[16], real_T c1_y[16]);
static void c1_eps(SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance);
static void c1_eml_matlab_zgetrf(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_b_A[16], int32_T c1_ipiv[4],
  int32_T *c1_info);
static int32_T c1_eml_ixamax(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T c1_ix0);
static int32_T c1_ceval_ixamax(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx);
static void c1_ceval_xswap(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T c1_ix0, int32_T c1_incx,
  int32_T c1_iy0, int32_T c1_incy, real_T c1_b_x[16]);
static void c1_ceval_xger(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T c1_alpha1, int32_T c1_ix0,
  int32_T c1_incx, int32_T c1_iy0, int32_T c1_incy, real_T c1_A[16], int32_T
  c1_ia0, int32_T c1_lda, real_T c1_b_A[16]);
static void c1_eml_blas_xtrsm(SFc1_DVM_Hirtle_global_frameInstanceStruct
...
static real_T c1_norm(SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance,
                      real_T c1_x[16]);
static void c1_eml_warning(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
static void c1_b_eml_warning(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_varargin_3);
static void c1_e_eml_scalar_eg(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
...
static void c1_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, const mxArray *c1_Fout, const char_T *c1_name, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, const mxArray *c1_acc_out, const char_T *c1_name, real_T c1_y
  [5]);
static void c1_c_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, const mxArray *c1_pdot, const char_T *c1_name, real_T c1_y[10]);
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct *
  chartInstance, const mxArray *c1_b_is_active_c1_DVM_Hirtle_global_frame, const
  char_T *c1_name);
static void init_dsm_address_info(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance);
  ...
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Hirtle_global_frame = 0U;
}
  ...
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_DVM_Hirtle_global_frame;
   ...
   )
{
  ...
  c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
                        "pdot", c1_dv2);
  for (c1_i10 = 0; c1_i10 < 10; c1_i10 = c1_i10 + 1) {
  ...
  chartInstance->c1_is_active_c1_DVM_Hirtle_global_frame = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_DVM_Hirtle_global_frame");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DVM_Hirtle_global_frame(chartInstance);
  ...
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance)
{
  ...
  for (c1_i13 = 0; c1_i13 < 10; c1_i13 = c1_i13 + 1) {
  ...
  c1_c1_DVM_Hirtle_global_frame(chartInstance);
  _sfEvent_ = c1_previousEvent;
  sf_debug_check_for_state_inconsistency(_DVM_Hirtle_global_frameMachineNumber_,
  ...
  (SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance)
{
  ...
  int32_T c1_i21;
  real_T c1_acc_in[5];
  uint32_T c1_debug_family_var_map[185];
  static const char *c1_sv0[185] = { "g", "v_x", "v_y", "phi", "phi_d", "psi",
    ...
    "Fxrf", "Fxlr", "Fxrr",
    "Fylf", "Fyrf", "Fylr", "Fyrr", "Mzlf", "Mzrf", "Mzlr", "Mzrr",
    "alpha_lf_new", "alpha_rf_new",
    "alpha_lr_new", "alpha_rr_new", "T_phif", "T_phir", "sigFx", "sigFy",
    "sigTxs", "sigTz", "x_d",
    "y_d", "A1", "A2", "A3", "B1", "B2", "B3", "B4", "C1", "C2", "C3", "C4",
    "D1", "D2", "D3", "D4",
    "D5", "D6", "Mass_Matrix", "F_Ec", "F_Eu", "a_x_new", "a_y_new",
    "phi_dd_new", "psi_dd_new",
  ...
  for (c1_i18 = 0; c1_i18 < 10; c1_i18 = c1_i18 + 1) {
  ...
  for (c1_i20 = 0; c1_i20 < 10; c1_i20 = c1_i20 + 1) {
  ...
  sf_debug_symbol_scope_push_eml(0U, 185U, 185U, c1_sv0, c1_debug_family_var_map);
  ...
  sf_debug_symbol_scope_add_eml(c1_varx, c1_i_sf_marshall, 60U);
  sf_debug_symbol_scope_add_eml(c1_vary, c1_j_sf_marshall, 61U);
  sf_debug_symbol_scope_add_eml(c1_varM, c1_i_sf_marshall, 62U);
  ...
  sf_debug_symbol_scope_add_eml(c1_ROT, c1_h_sf_marshall, 73U);
  sf_debug_symbol_scope_add_eml(c1_I_b, c1_h_sf_marshall, 74U);
  sf_debug_symbol_scope_add_eml(c1_I_c, c1_h_sf_marshall, 75U);
  ...
  sf_debug_symbol_scope_add_eml(&c1_Mtlf, c1_e_sf_marshall, 100U);
  sf_debug_symbol_scope_add_eml(&c1_Mtrf, c1_e_sf_marshall, 101U);
  sf_debug_symbol_scope_add_eml(&c1_Mtlr, c1_e_sf_marshall, 102U);
  sf_debug_symbol_scope_add_eml(&c1_Mtrr, c1_e_sf_marshall, 103U);
  sf_debug_symbol_scope_add_eml(&c1_delta, c1_e_sf_marshall, 104U);
  sf_debug_symbol_scope_add_eml(&c1_beta, c1_e_sf_marshall, 105U);
  sf_debug_symbol_scope_add_eml(&c1_beta_lf, c1_e_sf_marshall, 106U);
  sf_debug_symbol_scope_add_eml(&c1_beta_rf, c1_e_sf_marshall, 107U);
  sf_debug_symbol_scope_add_eml(&c1_beta_lr, c1_e_sf_marshall, 108U);
  sf_debug_symbol_scope_add_eml(&c1_beta_rr, c1_e_sf_marshall, 109U);
  sf_debug_symbol_scope_add_eml(&c1_C_alf, c1_e_sf_marshall, 110U);
  sf_debug_symbol_scope_add_eml(&c1_C_arf, c1_e_sf_marshall, 111U);
  sf_debug_symbol_scope_add_eml(&c1_C_alr, c1_e_sf_marshall, 112U);
  sf_debug_symbol_scope_add_eml(&c1_C_arr, c1_e_sf_marshall, 113U);
  sf_debug_symbol_scope_add_eml(&c1_a_lf, c1_e_sf_marshall, 114U);
  sf_debug_symbol_scope_add_eml(&c1_a_rf, c1_e_sf_marshall, 115U);
  sf_debug_symbol_scope_add_eml(&c1_a_lr, c1_e_sf_marshall, 116U);
  sf_debug_symbol_scope_add_eml(&c1_a_rr, c1_e_sf_marshall, 117U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtf, c1_e_sf_marshall, 118U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtlf, c1_e_sf_marshall, 119U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtrf, c1_e_sf_marshall, 120U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtlr, c1_e_sf_marshall, 121U);
  sf_debug_symbol_scope_add_eml(&c1_Fxtrr, c1_e_sf_marshall, 122U);
  sf_debug_symbol_scope_add_eml(&c1_Fytlf, c1_e_sf_marshall, 123U);
  sf_debug_symbol_scope_add_eml(&c1_Fytrf, c1_e_sf_marshall, 124U);
  sf_debug_symbol_scope_add_eml(&c1_Fytlr, c1_e_sf_marshall, 125U);
  sf_debug_symbol_scope_add_eml(&c1_Fytrr, c1_e_sf_marshall, 126U);
  sf_debug_symbol_scope_add_eml(&c1_Fxlf, c1_e_sf_marshall, 127U);
  sf_debug_symbol_scope_add_eml(&c1_Fxrf, c1_e_sf_marshall, 128U);
  sf_debug_symbol_scope_add_eml(&c1_Fxlr, c1_e_sf_marshall, 129U);
  sf_debug_symbol_scope_add_eml(&c1_Fxrr, c1_e_sf_marshall, 130U);
  sf_debug_symbol_scope_add_eml(&c1_Fylf, c1_e_sf_marshall, 131U);
  sf_debug_symbol_scope_add_eml(&c1_Fyrf, c1_e_sf_marshall, 132U);
  sf_debug_symbol_scope_add_eml(&c1_Fylr, c1_e_sf_marshall, 133U);
  sf_debug_symbol_scope_add_eml(&c1_Fyrr, c1_e_sf_marshall, 134U);
  sf_debug_symbol_scope_add_eml(&c1_Mzlf, c1_e_sf_marshall, 135U);
  sf_debug_symbol_scope_add_eml(&c1_Mzrf, c1_e_sf_marshall, 136U);
  sf_debug_symbol_scope_add_eml(&c1_Mzlr, c1_e_sf_marshall, 137U);
  sf_debug_symbol_scope_add_eml(&c1_Mzrr, c1_e_sf_marshall, 138U);
  sf_debug_symbol_scope_add_eml(&c1_alpha_lf_new, c1_e_sf_marshall, 139U);
  sf_debug_symbol_scope_add_eml(&c1_alpha_rf_new, c1_e_sf_marshall, 140U);
  sf_debug_symbol_scope_add_eml(&c1_alpha_lr_new, c1_e_sf_marshall, 141U);
  sf_debug_symbol_scope_add_eml(&c1_alpha_rr_new, c1_e_sf_marshall, 142U);
  sf_debug_symbol_scope_add_eml(&c1_T_phif, c1_e_sf_marshall, 143U);
  sf_debug_symbol_scope_add_eml(&c1_T_phir, c1_e_sf_marshall, 144U);
  sf_debug_symbol_scope_add_eml(&c1_sigFx, c1_e_sf_marshall, 145U);
  sf_debug_symbol_scope_add_eml(&c1_sigFy, c1_e_sf_marshall, 146U);
  sf_debug_symbol_scope_add_eml(&c1_sigTxs, c1_e_sf_marshall, 147U);
  sf_debug_symbol_scope_add_eml(&c1_sigTz, c1_e_sf_marshall, 148U);
  sf_debug_symbol_scope_add_eml(&c1_x_d, c1_e_sf_marshall, 149U);
  sf_debug_symbol_scope_add_eml(&c1_y_d, c1_e_sf_marshall, 150U);
  sf_debug_symbol_scope_add_eml(&c1_A1, c1_e_sf_marshall, 151U);
  sf_debug_symbol_scope_add_eml(&c1_A2, c1_e_sf_marshall, 152U);
  sf_debug_symbol_scope_add_eml(&c1_A3, c1_e_sf_marshall, 153U);
  sf_debug_symbol_scope_add_eml(&c1_B1, c1_e_sf_marshall, 154U);
  sf_debug_symbol_scope_add_eml(&c1_B2, c1_e_sf_marshall, 155U);
  sf_debug_symbol_scope_add_eml(&c1_B3, c1_e_sf_marshall, 156U);
  sf_debug_symbol_scope_add_eml(&c1_B4, c1_e_sf_marshall, 157U);
  sf_debug_symbol_scope_add_eml(&c1_C1, c1_e_sf_marshall, 158U);
  sf_debug_symbol_scope_add_eml(&c1_C2, c1_e_sf_marshall, 159U);
  sf_debug_symbol_scope_add_eml(&c1_C3, c1_e_sf_marshall, 160U);
  sf_debug_symbol_scope_add_eml(&c1_C4, c1_e_sf_marshall, 161U);
  sf_debug_symbol_scope_add_eml(&c1_D1, c1_e_sf_marshall, 162U);
  sf_debug_symbol_scope_add_eml(&c1_D2, c1_e_sf_marshall, 163U);
  sf_debug_symbol_scope_add_eml(&c1_D3, c1_e_sf_marshall, 164U);
  sf_debug_symbol_scope_add_eml(&c1_D4, c1_e_sf_marshall, 165U);
  sf_debug_symbol_scope_add_eml(&c1_D5, c1_e_sf_marshall, 166U);
  sf_debug_symbol_scope_add_eml(&c1_D6, c1_e_sf_marshall, 167U);
  sf_debug_symbol_scope_add_eml(c1_Mass_Matrix, c1_g_sf_marshall, 168U);
  sf_debug_symbol_scope_add_eml(c1_F_Ec, c1_f_sf_marshall, 169U);
  sf_debug_symbol_scope_add_eml(c1_F_Eu, c1_f_sf_marshall, 170U);
  sf_debug_symbol_scope_add_eml(&c1_a_x_new, c1_e_sf_marshall, 171U);
  sf_debug_symbol_scope_add_eml(&c1_a_y_new, c1_e_sf_marshall, 172U);
  sf_debug_symbol_scope_add_eml(&c1_phi_dd_new, c1_e_sf_marshall, 173U);
  sf_debug_symbol_scope_add_eml(&c1_psi_dd_new, c1_e_sf_marshall, 174U);
  sf_debug_symbol_scope_add_eml(&c1_nargin, c1_e_sf_marshall, 175U);
  sf_debug_symbol_scope_add_eml(&c1_nargout, c1_e_sf_marshall, 176U);
  sf_debug_symbol_scope_add_eml(c1_p, c1_c_sf_marshall, 177U);
  sf_debug_symbol_scope_add_eml(&c1_steer, c1_e_sf_marshall, 178U);
  sf_debug_symbol_scope_add_eml(&c1_torque, c1_e_sf_marshall, 179U);
  sf_debug_symbol_scope_add_eml(c1_acc_in, c1_d_sf_marshall, 180U);
  sf_debug_symbol_scope_add_eml(c1_pdot, c1_c_sf_marshall, 181U);
  sf_debug_symbol_scope_add_eml(c1_slp_ang, c1_sf_marshall, 182U);
  sf_debug_symbol_scope_add_eml(c1_acc_out, c1_b_sf_marshall, 183U);
  sf_debug_symbol_scope_add_eml(c1_Fout, c1_sf_marshall, 184U);
  CV_EML_FCN(0, 0);
  ...
  /* ==tire properties==% */
  _SFD_EML_CALL(0, 89);
  for (c1_i23 = 0; c1_i23 < 8; c1_i23 = c1_i23 + 1) {
    c1_varx[c1_i23] = c1_dv4[c1_i23];
  }

  /* slip curve coordinates (slip-%, mu) */
  _SFD_EML_CALL(0, 94);
  for (c1_i24 = 0; c1_i24 < 10; c1_i24 = c1_i24 + 1) {
    c1_vary[c1_i24] = c1_dv5[c1_i24];
  }

  /* slip curve coordinates (slip-%, mu)  */
  _SFD_EML_CALL(0, 100);
  for (c1_i25 = 0; c1_i25 < 8; c1_i25 = c1_i25 + 1) {
    c1_varM[c1_i25] = c1_dv6[c1_i25];
  }
  ...
  c1_g_b = c1_psi_dd;
  c1_g_y = 0.019926480905731212 * c1_g_b;
  c1_d_x = c1_phi;
  c1_e_x = c1_d_x;
  c1_f_x = c1_e_x;
  c1_e_x = c1_f_x;
  ...
  c1_h_b = c1_e_x;
  c1_h_y = 0.44554383628926192 * c1_h_b;
  c1_e_a = c1_h_y;
  c1_i_b = c1_phi_dd;
  c1_i_y = c1_e_a * c1_i_b;
  c1_j_b = c1_mpower(chartInstance, c1_phi_d);
  c1_j_y = 0.44554383628926192 * c1_j_b;
  c1_g_x = c1_phi;
  c1_h_x = c1_g_x;
  c1_i_x = c1_h_x;
  c1_h_x = c1_i_x;
  ...
  c1_f_a = c1_j_y;
  c1_k_b = c1_h_x;
  c1_k_y = c1_f_a * c1_k_b;
  c1_l_b = c1_mpower(chartInstance, c1_psi_d);
  c1_l_y = 0.44554383628926192 * c1_l_b;
  c1_j_x = c1_phi;
  c1_k_x = c1_j_x;
  c1_l_x = c1_k_x;
  c1_k_x = c1_l_x;
  ...
  c1_n_y = 1.0346864809057312 * c1_n_b;
  c1_a_ufx = c1_a_x - c1_n_y;
  _SFD_EML_CALL(0, 129);
  c1_o_b = c1_psi_dd;
  c1_o_y = 1.0346864809057312 * c1_o_b;
  c1_a_ufy = c1_a_y + c1_o_y;
  _SFD_EML_CALL(0, 130);
  c1_p_b = c1_mpower(chartInstance, c1_psi_d);
  c1_p_y = 1.6553135190942689 * c1_p_b;
  c1_a_urx = c1_a_x + c1_p_y;
  _SFD_EML_CALL(0, 131);
  c1_q_b = c1_psi_dd;
  c1_q_y = 1.6553135190942689 * c1_q_b;
  ...
  c1_eml_xgemm(chartInstance, c1_i_a, c1_dv9, c1_dv10, c1_r_y);
  for (c1_i33 = 0; c1_i33 < 9; c1_i33 = c1_i33 + 1) {
    c1_j_a[c1_i33] = c1_r_y[c1_i33];
  }
  ...
  for (c1_i35 = 0; c1_i35 < 3; c1_i35 = c1_i35 + 1) {
    ...
    for (c1_i37 = 0; c1_i37 < 3; c1_i37 = c1_i37 + 1) {
      c1_r_b[c1_i37 + c1_i34] = c1_ROT[c1_i36 + c1_i35];
      c1_i36 = c1_i36 + 3;
    }
  ...
  for (c1_i38 = 0; c1_i38 < 9; c1_i38 = c1_i38 + 1) {
    c1_k_a[c1_i38] = c1_j_a[c1_i38];
  }

  for (c1_i39 = 0; c1_i39 < 9; c1_i39 = c1_i39 + 1) {
    c1_s_b[c1_i39] = c1_r_b[c1_i39];
  }
  ...
  c1_eml_xgemm(chartInstance, c1_k_a, c1_s_b, c1_dv11, c1_dv12);
  for (c1_i41 = 0; c1_i41 < 9; c1_i41 = c1_i41 + 1) {
    c1_I_c[c1_i41] = c1_dv12[c1_i41];
  }
  ...
  _SFD_EML_CALL(0, 154);
  c1_t_b = c1_a_sx;
  c1_s_y = 680.300883630074 * c1_t_b;
  c1_u_b = c1_a_ufx;
  c1_t_y = 19.393667239976594 * c1_u_b;
  c1_v_b = c1_a_urx;
  c1_u_y = 15.756119052254176 * c1_v_b;
  ...
  _SFD_EML_CALL(0, 155);
  c1_w_b = c1_a_sy;
  c1_w_y = 122.14675375451863 * c1_w_b;
  c1_x_b = c1_a_ufy;
  c1_x_y = 19.393667239976594 * c1_x_b;
  c1_y_b = c1_w_y + c1_x_y;
  c1_Fzayf = 0.64935064935064934 * c1_y_b;
  _SFD_EML_CALL(0, 156);
  c1_ab_b = c1_a_sy;
  c1_y_y = 64.604054515407313 * c1_ab_b;
  c1_bb_b = c1_a_ury;
  c1_ab_y = 15.756119052254176 * c1_bb_b;
  c1_cb_b = c1_y_y + c1_ab_y;
  c1_Fzayr = 0.65359477124183007 * c1_cb_b;
  _SFD_EML_CALL(0, 157);
  c1_db_b = c1_phi;
  c1_bb_y = 47298.369313023613 * c1_db_b;
  c1_eb_b = c1_phi_d;
  c1_cb_y = 2717.2476562 * c1_eb_b;
  c1_fb_b = c1_bb_y + c1_cb_y;
  c1_Fzphif = -0.64935064935064934 * c1_fb_b;
  _SFD_EML_CALL(0, 158);
  c1_gb_b = c1_phi;
  c1_db_y = 37310.859108305551 * c1_gb_b;
  c1_hb_b = c1_phi_d;
  c1_eb_y = 2895.6587717249995 * c1_hb_b;
  c1_ib_b = c1_db_y + c1_eb_y;
  ...
  _SFD_EML_CALL(0, 193);
  if (CV_EML_IF(0, 0, c1_v_x < 11.1)) {
    _SFD_EML_CALL(0, 194);
    if (CV_EML_IF(0, 1, c1_omega_lf > c1_omega_rf)) {
      _SFD_EML_CALL(0, 195);
      c1_t_a = 11.1 - c1_v_x;
      c1_Mtlf = c1_t_a * 200.0;
      _SFD_EML_CALL(0, 196);
      c1_Mtrf = 0.0;
    } else {
      _SFD_EML_CALL(0, 198);
  ...
  c1_v_a = c1_rb_y;
  c1_delta = c1_v_a * 3.1415926535897931;
  ...
  _SFD_EML_CALL(0, 222);
  c1_jb_b = c1_Fzlf;
  c1_C_alf = 5.0 * c1_jb_b;
  _SFD_EML_CALL(0, 223);
  c1_kb_b = c1_Fzrf;
  c1_C_arf = 5.0 * c1_kb_b;
  _SFD_EML_CALL(0, 224);
  c1_lb_b = c1_Fzlr;
  c1_C_alr = 5.0 * c1_lb_b;
  _SFD_EML_CALL(0, 225);
  c1_mb_b = c1_Fzrr;
  c1_C_arr = 5.0 * c1_mb_b;
  _SFD_EML_CALL(0, 227);
  ...
  _SFD_EML_CALL(0, 235);
  if (CV_EML_IF(0, 2, c1_v_x < 11.1)) {
    _SFD_EML_CALL(0, 236);
    c1_w_a = 11.1 - c1_v_x;
    c1_Fxtf = c1_w_a * 20000.0;
  } else {
    _SFD_EML_CALL(0, 238);
    c1_Fxtf = 0.0;
  ...
  c1_x_a = -c1_a_lf;
  c1_nb_b = c1_C_alf;
  c1_Fytlf = c1_x_a * c1_nb_b;
  _SFD_EML_CALL(0, 247);
  c1_y_a = -c1_a_rf;
  c1_ob_b = c1_C_arf;
  c1_Fytrf = c1_y_a * c1_ob_b;
  _SFD_EML_CALL(0, 248);
  c1_ab_a = -c1_a_lr;
  c1_pb_b = c1_C_alr;
  c1_Fytlr = c1_ab_a * c1_pb_b;
  _SFD_EML_CALL(0, 249);
  c1_bb_a = -c1_a_rr;
  c1_qb_b = c1_C_arr;
  c1_Fytrr = c1_bb_a * c1_qb_b;
  _SFD_EML_CALL(0, 252);
  c1_sc_x = c1_delta;
  c1_tc_x = c1_sc_x;
  c1_uc_x = c1_tc_x;
  ...
  c1_cb_a = c1_Fytlf;
  c1_sb_b = c1_wc_x;
  c1_oc_y = c1_cb_a * c1_sb_b;
  c1_Fxlf = c1_nc_y - c1_oc_y;
  _SFD_EML_CALL(0, 253);
  c1_yc_x = c1_delta;
  c1_ad_x = c1_yc_x;
  c1_bd_x = c1_ad_x;
  ...
  c1_db_a = c1_Fytrf;
  c1_ub_b = c1_dd_x;
  c1_qc_y = c1_db_a * c1_ub_b;
  c1_Fxrf = c1_pc_y - c1_qc_y;
  _SFD_EML_CALL(0, 254);
  c1_Fxlr = 0.0;
  _SFD_EML_CALL(0, 255);
  c1_Fxrr = 0.0;
  ...
  _SFD_EML_CALL(0, 283);
  c1_ac_b = c1_phi;
  c1_vc_y = -47298.369313023613 * c1_ac_b;
  c1_bc_b = c1_phi_d;
  c1_wc_y = 2717.2476562 * c1_bc_b;
  c1_T_phif = c1_vc_y - c1_wc_y;
  _SFD_EML_CALL(0, 284);
  c1_cc_b = c1_phi;
  c1_xc_y = -37310.859108305551 * c1_cc_b;
  c1_dc_b = c1_phi_d;
  c1_yc_y = 2895.6587717249995 * c1_dc_b;
  c1_T_phir = c1_xc_y - c1_yc_y;
  ...
  c1_ec_b = c1_sd_x;
  c1_ad_y = 6673.7516684110269 * c1_ec_b;
  c1_fc_b = c1_a_sy;
  c1_bd_y = 680.300883630074 * c1_fc_b;
  c1_ud_x = c1_phi;
  c1_vd_x = c1_ud_x;
  c1_wd_x = c1_vd_x;
  c1_vd_x = c1_wd_x;
  ...
  c1_gb_a = c1_bd_y;
  c1_gc_b = c1_vd_x;
  c1_cd_y = c1_gb_a * c1_gc_b;
  c1_sigTxs = ((c1_T_phif + c1_T_phir) - c1_ad_y) + c1_cd_y;
  _SFD_EML_CALL(0, 292);
  c1_hb_a = c1_Fylf + c1_Fyrf;
  c1_dd_y = c1_hb_a * 1.0346864809057312;
  c1_ib_a = c1_Fylr + c1_Fyrr;
  c1_ed_y = c1_ib_a * 1.6553135190942689;
  c1_hc_b = c1_Fxlf - c1_Fxrf;
  c1_fd_y = 0.77 * c1_hc_b;
  c1_sigTz = (((((c1_dd_y - c1_ed_y) + c1_fd_y) + c1_Mzlf) + c1_Mzrf) + c1_Mzlr)
    + c1_Mzrr;
  ...
  _SFD_EML_CALL(0, 336);
  c1_C1 = -0.0080845596594018715;
  _SFD_EML_CALL(0, 337);
  c1_C2 = 0.0013440591664742624;
  _SFD_EML_CALL(0, 338);
  c1_C3 = -0.0080845596594018715;
  _SFD_EML_CALL(0, 339);
  c1_C4 = -0.24559168639049464;
  _SFD_EML_CALL(0, 341);
  c1_f_B = c1_I_zzo;
  c1_gd_y = c1_f_B;
  c1_hd_y = c1_gd_y;
  c1_id_y = c1_hd_y;
  c1_D1 = -6.0150325678067418 / c1_id_y;
  _SFD_EML_CALL(0, 342);
  c1_g_B = c1_I_zzo;
  c1_jd_y = c1_g_B;
  c1_kd_y = c1_jd_y;
  c1_ld_y = c1_kd_y;
  c1_D2 = 680.300883630074 / c1_ld_y;
  _SFD_EML_CALL(0, 343);
  c1_h_B = c1_I_zzo;
  c1_md_y = c1_h_B;
  c1_nd_y = c1_md_y;
  ...
  c1_qd_y = c1_pd_y;
  c1_rd_y = c1_qd_y;
  c1_D4 = 6.0150325678067418 / c1_rd_y;
  _SFD_EML_CALL(0, 345);
  c1_j_B = c1_I_zzo;
  c1_sd_y = c1_j_B;
  c1_td_y = c1_sd_y;
  c1_ud_y = c1_td_y;
  c1_D5 = 6.0150325678067418 / c1_ud_y;
  _SFD_EML_CALL(0, 346);
  c1_k_B = c1_I_zzo;
  c1_vd_y = c1_k_B;
  c1_wd_y = c1_vd_y;
  c1_xd_y = c1_wd_y;
  c1_D6 = 6.0150325678067418 / c1_xd_y;
  ...
  c1_ic_b = c1_yd_x;
  c1_yd_y = 0.39907366905031622 * c1_ic_b;
  c1_be_x = c1_phi;
  c1_ce_x = c1_be_x;
  c1_de_x = c1_ce_x;
  c1_ce_x = c1_de_x;
  c1_ce_x = muDoubleScalarCos(c1_ce_x);
  c1_jc_b = c1_ce_x;
  c1_ae_y = -0.89570012318883085 * c1_jc_b;
  c1_ee_x = c1_phi;
  c1_fe_x = c1_ee_x;
  c1_ge_x = c1_fe_x;
  c1_fe_x = c1_ge_x;
  ...
  c1_kc_b = c1_fe_x;
  c1_be_y = -0.0080845596594018715 * c1_kc_b;
  c1_he_x = c1_phi;
  c1_ie_x = c1_he_x;
  c1_je_x = c1_ie_x;
  c1_ie_x = c1_je_x;
  c1_ie_x = muDoubleScalarSin(c1_ie_x);
  c1_jb_a = c1_D2;
  c1_lc_b = c1_ie_x;
  c1_ce_y = c1_jb_a * c1_lc_b;
  c1_ke_x = c1_phi;
  c1_le_x = c1_ke_x;
  c1_me_x = c1_le_x;
  c1_le_x = c1_me_x;
  ...
  c1_kb_a = c1_D1;
  c1_mc_b = c1_le_x;
  c1_de_y = c1_kb_a * c1_mc_b;
  c1_Mass_Matrix[0] = 1.0;
  c1_Mass_Matrix[4] = 0.0;
  c1_Mass_Matrix[8] = 0.0;
  c1_Mass_Matrix[12] = c1_yd_y;
  c1_Mass_Matrix[1] = 0.0;
  c1_Mass_Matrix[5] = 1.0;
  c1_Mass_Matrix[9] = c1_ae_y;
  c1_Mass_Matrix[13] = 0.0;
  c1_Mass_Matrix[2] = 0.0;
  c1_Mass_Matrix[6] = 0.0;
  c1_Mass_Matrix[10] = 1.0;
  c1_Mass_Matrix[14] = c1_be_y;
  c1_Mass_Matrix[3] = c1_ce_y;
  c1_Mass_Matrix[7] = 0.0;
  c1_Mass_Matrix[11] = c1_de_y;
  c1_Mass_Matrix[15] = 1.0;

  /*  coupled equations of motion for x_dd, y_dd, phi_dd, psi_dd */
  _SFD_EML_CALL(0, 355);
  c1_nc_b = c1_sigFx;
  c1_ee_y = 0.000586613480377779 * c1_nc_b;
  c1_lb_a = c1_psi_d;
  c1_oc_b = c1_x_d;
  c1_fe_y = c1_lb_a * c1_oc_b;
  c1_ne_x = c1_phi;
  c1_oe_x = c1_ne_x;
  c1_pe_x = c1_oe_x;
  c1_oe_x = c1_pe_x;
  c1_oe_x = muDoubleScalarCos(c1_oe_x);
  c1_pc_b = c1_oe_x;
  c1_ge_y = -0.79814733810063243 * c1_pc_b;
  c1_mb_a = c1_ge_y;
  c1_qc_b = c1_phi_d;
  c1_he_y = c1_mb_a * c1_qc_b;
  c1_nb_a = c1_he_y;
  c1_rc_b = c1_psi_d;
  c1_ie_y = c1_nb_a * c1_rc_b;
  c1_sc_b = c1_sigFy;
  c1_je_y = 0.000586613480377779 * c1_sc_b;
  c1_ob_a = c1_psi_d;
  c1_tc_b = c1_y_d;
  c1_ke_y = c1_ob_a * c1_tc_b;
  c1_qe_x = c1_phi;
  c1_re_x = c1_qe_x;
  c1_se_x = c1_re_x;
  c1_re_x = c1_se_x;
  c1_re_x = muDoubleScalarSin(c1_re_x);
  c1_uc_b = c1_re_x;
  c1_le_y = -0.39907366905031622 * c1_uc_b;
  c1_pb_a = c1_le_y;
  c1_vc_b = c1_mpower(chartInstance, c1_phi_d);
  c1_me_y = c1_pb_a * c1_vc_b;
  c1_te_x = c1_phi;
  c1_ue_x = c1_te_x;
  c1_ve_x = c1_ue_x;
  c1_ue_x = c1_ve_x;
  ...
  c1_wc_b = c1_ue_x;
  c1_ne_y = -0.39907366905031622 * c1_wc_b;
  c1_qb_a = c1_ne_y;
  c1_xc_b = c1_mpower(chartInstance, c1_psi_d);
  c1_oe_y = c1_qb_a * c1_xc_b;
  c1_yc_b = c1_sigTxs;
  c1_pe_y = 0.0013440591664742624 * c1_yc_b;
  c1_we_x = c1_phi;
  c1_xe_x = c1_we_x;
  c1_ye_x = c1_xe_x;
  c1_xe_x = c1_ye_x;
  ...
  c1_ad_b = c1_xe_x;
  c1_qe_y = -0.0080845596594018715 * c1_ad_b;
  c1_af_x = c1_phi;
  c1_bf_x = c1_af_x;
  c1_cf_x = c1_bf_x;
  c1_bf_x = c1_cf_x;
  ...
  c1_rb_a = c1_qe_y;
  c1_bd_b = c1_bf_x;
  c1_re_y = c1_rb_a * c1_bd_b;
  c1_sb_a = c1_re_y;
  c1_cd_b = c1_phi_d;
  c1_se_y = c1_sb_a * c1_cd_b;
  c1_tb_a = c1_se_y;
  c1_dd_b = c1_psi_d;
  c1_te_y = c1_tb_a * c1_dd_b;
  c1_df_x = c1_phi;
  c1_ef_x = c1_df_x;
  c1_ff_x = c1_ef_x;
  c1_ef_x = c1_ff_x;
  ...
  c1_ed_b = c1_ef_x;
  c1_ue_y = -0.24559168639049464 * c1_ed_b;
  c1_gf_x = c1_phi;
  c1_hf_x = c1_gf_x;
  c1_if_x = c1_hf_x;
  c1_hf_x = c1_if_x;
  ...
  c1_ub_a = c1_ue_y;
  c1_fd_b = c1_hf_x;
  c1_ve_y = c1_ub_a * c1_fd_b;
  c1_vb_a = c1_ve_y;
  c1_gd_b = c1_mpower(chartInstance, c1_psi_d);
  c1_we_y = c1_vb_a * c1_gd_b;
  c1_wb_a = c1_D3;
  c1_hd_b = c1_sigTz;
  c1_xe_y = c1_wb_a * c1_hd_b;
  c1_jf_x = c1_phi;
  c1_kf_x = c1_jf_x;
  c1_lf_x = c1_kf_x;
  c1_kf_x = c1_lf_x;
  ...
  c1_xb_a = c1_D4;
  c1_id_b = c1_kf_x;
  c1_ye_y = c1_xb_a * c1_id_b;
  c1_mf_x = c1_phi;
  c1_nf_x = c1_mf_x;
  c1_of_x = c1_nf_x;
  c1_nf_x = c1_of_x;
  c1_nf_x = muDoubleScalarCos(c1_nf_x);
  c1_yb_a = c1_ye_y;
  c1_jd_b = c1_nf_x;
  c1_af_y = c1_yb_a * c1_jd_b;
  c1_ac_a = c1_af_y;
  c1_kd_b = c1_phi_d;
  c1_bf_y = c1_ac_a * c1_kd_b;
  c1_bc_a = c1_bf_y;
  c1_ld_b = c1_psi_d;
  c1_cf_y = c1_bc_a * c1_ld_b;
  c1_pf_x = c1_phi;
  c1_qf_x = c1_pf_x;
  c1_rf_x = c1_qf_x;
  c1_qf_x = c1_rf_x;
  ...
  c1_cc_a = c1_D5;
  c1_md_b = c1_qf_x;
  c1_df_y = c1_cc_a * c1_md_b;
  c1_dc_a = c1_df_y;
  c1_nd_b = c1_mpower(chartInstance, c1_phi_d);
  c1_ef_y = c1_dc_a * c1_nd_b;
  c1_sf_x = c1_phi;
  c1_tf_x = c1_sf_x;
  c1_uf_x = c1_tf_x;
  c1_tf_x = c1_uf_x;
  ...
  c1_fc_a = c1_ff_y;
  c1_pd_b = c1_wf_x;
  c1_gf_y = c1_fc_a * c1_pd_b;
  c1_gc_a = c1_gf_y;
  c1_qd_b = c1_mpower(chartInstance, c1_psi_d);
  c1_hf_y = c1_gc_a * c1_qd_b;
  c1_F_Ec[0] = (c1_ee_y + c1_fe_y) + c1_ie_y;
  c1_F_Ec[1] = ((c1_je_y - c1_ke_y) + c1_me_y) + c1_oe_y;
  c1_F_Ec[2] = (c1_pe_y + c1_te_y) + c1_we_y;
  c1_F_Ec[3] = ((c1_xe_y + c1_cf_y) + c1_ef_y) + c1_hf_y;
  ...
  for (c1_i51 = 0; c1_i51 < 4; c1_i51 = c1_i51 + 1) {
    ...
    for (c1_i53 = 0; c1_i53 < 4; c1_i53 = c1_i53 + 1) {
      c1_F_Eu[c1_i51] = c1_F_Eu[c1_i51] + c1_n_A[c1_i52 + c1_i51] *
        c1_n_B[c1_i53];
      c1_i52 = c1_i52 + 4;
    }
  }
  ...
  _SFD_EML_CALL(0, 366);
  c1_a_x_new = c1_F_Eu[0];
  _SFD_EML_CALL(0, 367);
  c1_a_y_new = c1_F_Eu[1];
  _SFD_EML_CALL(0, 368);
  c1_phi_dd_new = c1_F_Eu[2];
  _SFD_EML_CALL(0, 369);
  c1_psi_dd_new = c1_F_Eu[3];
  ...
  for (c1_i54 = 0; c1_i54 < 10; c1_i54 = c1_i54 + 1) {
...
static void c1_eml_xgemm(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_A[9], real_T c1_B[9], real_T c1_C[9],
  real_T c1_b_C[9])
{
  int32_T c1_i60;
  real_T c1_b_A[9];
...
static void c1_eml_matlab_zgetrf(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, real_T c1_A[16], real_T c1_b_A[16],
...
static int32_T c1_eml_ixamax(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, int32_T c1_n, real_T c1_x[16], int32_T
  c1_ix0)
{
  int32_T c1_b_n;
  int32_T c1_i141;
...
static void c1_eml_blas_xtrsm(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, int32_T c1_m, int32_T c1_n, real_T
  c1_alpha1, real_T c1_A[16], int32_T c1_ia0, int32_T c1_lda, real_T c1_B[16],
  int32_T c1_ib0, int32_T c1_ldb, real_T c1_b_B[16])
{
  int32_T c1_i145;
  int32_T c1_b_m;
  int32_T c1_b_n;
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Hirtle_global_frameInstanceStruct *)
    chartInstanceVoid;
  c1_y = NULL;
...
static const mxArray *c1_c_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Hirtle_global_frameInstanceStruct *)
    chartInstanceVoid;
  c1_y = NULL;
  for (c1_i158 = 0; c1_i158 < 10; c1_i158 = c1_i158 + 1) {
    c1_b_u[c1_i158] = (*((real_T (*)[10])c1_u))[c1_i158];
  }

  for (c1_i159 = 0; c1_i159 < 10; c1_i159 = c1_i159 + 1) {
...
static const mxArray *c1_d_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Hirtle_global_frameInstanceStruct *)
    chartInstanceVoid;
  c1_y = NULL;
  for (c1_i160 = 0; c1_i160 < 5; c1_i160 = c1_i160 + 1) {
    c1_b_u[c1_i160] = (*((real_T (*)[5])c1_u))[c1_i160];
  }

  for (c1_i161 = 0; c1_i161 < 5; c1_i161 = c1_i161 + 1) {
...
static const mxArray *c1_f_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i162 = 0; c1_i162 < 4; c1_i162 = c1_i162 + 1) {
    c1_b_u[c1_i162] = (*((real_T (*)[4])c1_u))[c1_i162];
  }

  for (c1_i163 = 0; c1_i163 < 4; c1_i163 = c1_i163 + 1) {
    c1_c_u[c1_i163] = c1_b_u[c1_i163];
  }
...
static const mxArray *c1_g_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i164 = 0;
  for (c1_i165 = 0; c1_i165 < 4; c1_i165 = c1_i165 + 1) {
    for (c1_i166 = 0; c1_i166 < 4; c1_i166 = c1_i166 + 1) {
      c1_b_u[c1_i166 + c1_i164] = (*((real_T (*)[16])c1_u))[c1_i166 + c1_i164];
    }
  ...
  for (c1_i168 = 0; c1_i168 < 4; c1_i168 = c1_i168 + 1) {
    for (c1_i169 = 0; c1_i169 < 4; c1_i169 = c1_i169 + 1) {
      c1_c_u[c1_i169 + c1_i167] = c1_b_u[c1_i169 + c1_i167];
    }
...
static const mxArray *c1_h_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i171 = 0; c1_i171 < 3; c1_i171 = c1_i171 + 1) {
    for (c1_i172 = 0; c1_i172 < 3; c1_i172 = c1_i172 + 1) {
      c1_b_u[c1_i172 + c1_i170] = (*((real_T (*)[9])c1_u))[c1_i172 + c1_i170];
    }
  ...
  c1_i173 = 0;
  for (c1_i174 = 0; c1_i174 < 3; c1_i174 = c1_i174 + 1) {
    for (c1_i175 = 0; c1_i175 < 3; c1_i175 = c1_i175 + 1) {
      c1_c_u[c1_i175 + c1_i173] = c1_b_u[c1_i175 + c1_i173];
    }
...
static const mxArray *c1_i_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i176 = 0;
  for (c1_i177 = 0; c1_i177 < 2; c1_i177 = c1_i177 + 1) {
    for (c1_i178 = 0; c1_i178 < 4; c1_i178 = c1_i178 + 1) {
      c1_b_u[c1_i178 + c1_i176] = (*((real_T (*)[8])c1_u))[c1_i178 + c1_i176];
    }
  ...
  c1_i179 = 0;
  for (c1_i180 = 0; c1_i180 < 2; c1_i180 = c1_i180 + 1) {
    for (c1_i181 = 0; c1_i181 < 4; c1_i181 = c1_i181 + 1) {
      c1_c_u[c1_i181 + c1_i179] = c1_b_u[c1_i181 + c1_i179];
    }
...
static const mxArray *c1_j_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i183 = 0; c1_i183 < 2; c1_i183 = c1_i183 + 1) {
    for (c1_i184 = 0; c1_i184 < 5; c1_i184 = c1_i184 + 1) {
      c1_b_u[c1_i184 + c1_i182] = (*((real_T (*)[10])c1_u))[c1_i184 + c1_i182];
    }
  ...
  c1_i185 = 0;
  for (c1_i186 = 0; c1_i186 < 2; c1_i186 = c1_i186 + 1) {
    for (c1_i187 = 0; c1_i187 < 5; c1_i187 = c1_i187 + 1) {
      c1_c_u[c1_i187 + c1_i185] = c1_b_u[c1_i187 + c1_i185];
    }
...
const mxArray *sf_c1_DVM_Hirtle_global_frame_get_eml_resolved_functions_info
  (void)
{
...
static void c1_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, const mxArray *c1_Fout, const char_T *
  c1_name, real_T c1_y[4])
{
  real_T c1_dv13[4];
  int32_T c1_i189;
  sf_mex_import(c1_name, sf_mex_dup(c1_Fout), c1_dv13, 1, 0, 0U, 1, 0U, 2, 1, 4);
  for (c1_i189 = 0; c1_i189 < 4; c1_i189 = c1_i189 + 1) {
    c1_y[c1_i189] = c1_dv13[c1_i189];
  }
  ...
  *c1_name, real_T c1_y[5])
{
  real_T c1_dv14[5];
  int32_T c1_i190;
  sf_mex_import(c1_name, sf_mex_dup(c1_acc_out), c1_dv14, 1, 0, 0U, 1, 0U, 2, 1,
                5);
  for (c1_i190 = 0; c1_i190 < 5; c1_i190 = c1_i190 + 1) {
    c1_y[c1_i190] = c1_dv14[c1_i190];
  }
...
static void c1_c_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct
  *chartInstance, const mxArray *c1_pdot, const char_T *
  c1_name, real_T c1_y[10])
{
  real_T c1_dv15[10];
  int32_T c1_i191;
  sf_mex_import(c1_name, sf_mex_dup(c1_pdot), c1_dv15, 1, 0, 0U, 1, 0U, 1, 10);
  for (c1_i191 = 0; c1_i191 < 10; c1_i191 = c1_i191 + 1) {
    c1_y[c1_i191] = c1_dv15[c1_i191];
  }
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Hirtle_global_frameInstanceStruct *
  ...
  c1_b_is_active_c1_DVM_Hirtle_global_frame, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_DVM_Hirtle_global_frame),
                &c1_u0, 1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_DVM_Hirtle_global_frame);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_DVM_Hirtle_global_frame_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1637960040U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1342307278U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(639725651U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(390311033U);
}

mxArray *sf_c1_DVM_Hirtle_global_frame_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(715971582U);
    pr[1] = (double)(2123618747U);
    pr[2] = (double)(4100418944U);
    pr[3] = (double)(2954809414U);
...
static mxArray *sf_get_sim_state_info_c1_DVM_Hirtle_global_frame(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[11],T\"Fout\",},{M[1],M[10],T\"acc_out\",},{M[1],M[5],T\"pdot\",},{M[1],M[9],T\"slp_ang\",},{M[8],M[0],T\"is_active_c1_DVM_Hirtle_global_frame\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DVM_Hirtle_global_frame_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_DVM_Hirtle_global_frameMachineNumber_,
           1,
           1,
           1,
           8,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_DVM_Hirtle_global_frameMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_DVM_Hirtle_global_frameMachineNumber_,chartInstance->chartNumber,1);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,10584);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(2,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c1_l_sf_marshall);
      ...
      sf_debug_reset_current_state_configuration
        (_DVM_Hirtle_global_frameMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_DVM_Hirtle_global_frame(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DVM_Hirtle_global_frameInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_DVM_Hirtle_global_frame
    ((SFc1_DVM_Hirtle_global_frameInstanceStruct*) chartInstanceVar);
  initialize_c1_DVM_Hirtle_global_frame
    ((SFc1_DVM_Hirtle_global_frameInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DVM_Hirtle_global_frame(void *chartInstanceVar)
{
  enable_c1_DVM_Hirtle_global_frame((SFc1_DVM_Hirtle_global_frameInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_DVM_Hirtle_global_frame(void *chartInstanceVar)
{
  disable_c1_DVM_Hirtle_global_frame((SFc1_DVM_Hirtle_global_frameInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_DVM_Hirtle_global_frame(void *chartInstanceVar)
{
  sf_c1_DVM_Hirtle_global_frame((SFc1_DVM_Hirtle_global_frameInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_DVM_Hirtle_global_frame(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DVM_Hirtle_global_frame
    ((SFc1_DVM_Hirtle_global_frameInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_DVM_Hirtle_global_frame();/* state var info */
...
static void sf_internal_set_sim_state_c1_DVM_Hirtle_global_frame(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DVM_Hirtle_global_frame();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_DVM_Hirtle_global_frame
    ((SFc1_DVM_Hirtle_global_frameInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_DVM_Hirtle_global_frame(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DVM_Hirtle_global_frame(S);
}

static void sf_opaque_set_sim_state_c1_DVM_Hirtle_global_frame(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_DVM_Hirtle_global_frame(S, st);
}

static void sf_opaque_terminate_c1_DVM_Hirtle_global_frame(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DVM_Hirtle_global_frameInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_DVM_Hirtle_global_frame
      ((SFc1_DVM_Hirtle_global_frameInstanceStruct*) chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_DVM_Hirtle_global_frame
    ((SFc1_DVM_Hirtle_global_frameInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DVM_Hirtle_global_frame(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_DVM_Hirtle_global_frame
      ((SFc1_DVM_Hirtle_global_frameInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DVM_Hirtle_global_frame(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DVM_Hirtle_global_frame",
      "DVM_Hirtle_global_frame",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DVM_Hirtle_global_frame",
                "DVM_Hirtle_global_frame",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,
      "DVM_Hirtle_global_frame","DVM_Hirtle_global_frame",1,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"DVM_Hirtle_global_frame",
        "DVM_Hirtle_global_frame",1,4);
      sf_mark_chart_reusable_outputs(S,"DVM_Hirtle_global_frame",
        "DVM_Hirtle_global_frame",1,4);
    }

    sf_set_rtw_dwork_info(S,"DVM_Hirtle_global_frame","DVM_Hirtle_global_frame",
                          1);
  ...
  ssSetChecksum0(S,(1637271725U));
  ssSetChecksum1(S,(4217659354U));
  ssSetChecksum2(S,(482868811U));
  ssSetChecksum3(S,(4157474793U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_DVM_Hirtle_global_frame(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DVM_Hirtle_global_frame",
      "DVM_Hirtle_global_frame",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_DVM_Hirtle_global_frame(SimStruct *S)
{
  SFc1_DVM_Hirtle_global_frameInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Hirtle_global_frameInstanceStruct *)malloc(sizeof
    (SFc1_DVM_Hirtle_global_frameInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DVM_Hirtle_global_frameInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DVM_Hirtle_global_frame;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DVM_Hirtle_global_frame;
...
void c1_DVM_Hirtle_global_frame_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DVM_Hirtle_global_frame(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DVM_Hirtle_global_frame(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DVM_Hirtle_global_frame(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DVM_Hirtle_global_frame_method_dispatcher.\n"
