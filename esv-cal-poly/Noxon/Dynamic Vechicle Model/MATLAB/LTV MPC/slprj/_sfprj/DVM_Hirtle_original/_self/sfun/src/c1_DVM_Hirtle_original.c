...
#include "DVM_Hirtle_original_sfun.h"
#include "c1_DVM_Hirtle_original.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "DVM_Hirtle_original_sfun_debug_macros.h"
...
static const char *c1_debug_family_names[163] = { "g", "v_x", "v_y", "phi",
  ...
  "sigTz", "a_x_new", "a_y_new", "phi_dd_new", "psi_dd_new", "nargin", "nargout",
  "p", "steer", "torque", "acc_in", "pdot", "slp_ang", "acc_out", "Fout" };

/* Function Declarations */
static void initialize_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void initialize_params_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void enable_c1_DVM_Hirtle_original(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance);
static void disable_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void set_sim_state_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void sf_c1_DVM_Hirtle_original(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance);
static void c1_c1_DVM_Hirtle_original(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c1_DVM_Hirtle_original
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static real_T c1_mpower(SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance,
  real_T c1_a);
static real_T c1_power(SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance,
  real_T c1_a, real_T c1_b);
static void c1_eml_scalar_eg(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance);
static void c1_eml_error(SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance);
static void c1_eml_xgemm(SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance,
  real_T c1_A[9], real_T c1_B[9], real_T c1_C[9], real_T c1_b_C[9]);
static real_T c1_b_mpower(SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance,
  real_T c1_a);
...
static void c1_emlrt_marshallIn(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance, const mxArray *c1_Fout, const char_T *c1_name, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance, const mxArray *c1_acc_out, const char_T *c1_name, real_T c1_y
  [5]);
static void c1_c_emlrt_marshallIn(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance, const mxArray *c1_pdot, const char_T *c1_name, real_T c1_y[10]);
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_DVM_Hirtle_original, const
  char_T *c1_name);
static void init_dsm_address_info(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance);
  ...
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Hirtle_original = 0U;
}
  ...
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_DVM_Hirtle_original;
  ...
  (SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_DVM_Hirtle_original = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_DVM_Hirtle_original");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DVM_Hirtle_original(chartInstance);
  ...
  *chartInstance)
{
  ...
  c1_c1_DVM_Hirtle_original(chartInstance);
  _sfEvent_ = c1_previousEvent;
  sf_debug_check_for_state_inconsistency(_DVM_Hirtle_originalMachineNumber_,
  ...
  *chartInstance)
{
  ...
  int32_T c1_i21;
  real_T c1_acc_in[5];
  uint32_T c1_debug_family_var_map[163];
  static const char *c1_sv0[163] = { "g", "v_x", "v_y", "phi", "phi_d", "psi",
    ...
    "steer", "torque",
    "acc_in", "pdot", "slp_ang", "acc_out", "Fout" };
  ...
  sf_debug_symbol_scope_push_eml(0U, 163U, 163U, c1_sv0, c1_debug_family_var_map);
  ...
  sf_debug_symbol_scope_add_eml(&c1_a_x_new, c1_e_sf_marshall, 149U);
  sf_debug_symbol_scope_add_eml(&c1_a_y_new, c1_e_sf_marshall, 150U);
  sf_debug_symbol_scope_add_eml(&c1_phi_dd_new, c1_e_sf_marshall, 151U);
  sf_debug_symbol_scope_add_eml(&c1_psi_dd_new, c1_e_sf_marshall, 152U);
  ...
  c1_ge_x = c1_fe_x;
  c1_z = c1_ge_x / 1704.7;
  c1_a_x_new = c1_gd_y + c1_z;
  _SFD_EML_CALL(0, 301);
  c1_kb_a = -c1_psi_d;
  c1_jc_b = c1_v_x;
  c1_hd_y = c1_kb_a * c1_jc_b;
  c1_kc_b = c1_phi_dd;
  c1_id_y = -0.44554383628926192 * c1_kc_b;
  c1_he_x = c1_phi;
  c1_ie_x = c1_he_x;
  c1_je_x = c1_ie_x;
  c1_ie_x = c1_je_x;
  ...
  c1_lb_a = c1_id_y;
  c1_lc_b = c1_ie_x;
  c1_jd_y = c1_lb_a * c1_lc_b;
  c1_mc_b = c1_mpower(chartInstance, c1_phi_d);
  c1_kd_y = 0.44554383628926192 * c1_mc_b;
  c1_ke_x = c1_phi;
  c1_le_x = c1_ke_x;
  c1_me_x = c1_le_x;
  c1_le_x = c1_me_x;
  ...
  c1_mb_a = c1_kd_y;
  c1_nc_b = c1_le_x;
  c1_ld_y = c1_mb_a * c1_nc_b;
  c1_oc_b = c1_mpower(chartInstance, c1_psi_d);
  c1_md_y = 0.44554383628926192 * c1_oc_b;
  c1_ne_x = c1_phi;
  c1_oe_x = c1_ne_x;
  c1_pe_x = c1_oe_x;
  c1_oe_x = c1_pe_x;
  ...
  c1_nb_a = c1_md_y;
  c1_pc_b = c1_oe_x;
  c1_nd_y = c1_nb_a * c1_pc_b;
  c1_qc_b = (c1_jd_y + c1_ld_y) + c1_nd_y;
  c1_od_y = 1526.9 * c1_qc_b;
  c1_qe_x = c1_sigFy - c1_od_y;
  c1_re_x = c1_qe_x;
  c1_se_x = c1_re_x;
  c1_b_z = c1_se_x / 1704.7;
  c1_a_y_new = c1_hd_y + c1_b_z;
  _SFD_EML_CALL(0, 305);
  c1_te_x = c1_phi;
  c1_ue_x = c1_te_x;
  c1_ve_x = c1_ue_x;
  ...
  c1_rc_b = c1_ue_x;
  c1_pd_y = 21.096972567806741 * c1_rc_b;
  c1_ob_a = c1_pd_y;
  c1_sc_b = c1_psi_dd;
  c1_qd_y = c1_ob_a * c1_sc_b;
  c1_we_x = c1_phi;
  c1_xe_x = c1_we_x;
  c1_ye_x = c1_xe_x;
  c1_xe_x = c1_ye_x;
  ...
  c1_tc_b = c1_xe_x;
  c1_rd_y = 21.096972567806741 * c1_tc_b;
  c1_pb_a = c1_rd_y;
  c1_uc_b = c1_phi_d;
  c1_sd_y = c1_pb_a * c1_uc_b;
  c1_qb_a = c1_sd_y;
  c1_vc_b = c1_psi_d;
  c1_td_y = c1_qb_a * c1_vc_b;
  c1_af_x = c1_phi;
  c1_bf_x = c1_af_x;
  c1_cf_x = c1_bf_x;
  c1_bf_x = c1_cf_x;
  ...
  c1_wc_b = c1_bf_x;
  c1_ud_y = -182.72386552351787 * c1_wc_b;
  c1_df_x = c1_phi;
  c1_ef_x = c1_df_x;
  c1_ff_x = c1_ef_x;
  c1_ef_x = c1_ff_x;
  ...
  c1_rb_a = c1_ud_y;
  c1_xc_b = c1_ef_x;
  c1_vd_y = c1_rb_a * c1_xc_b;
  c1_sb_a = c1_vd_y;
  c1_yc_b = c1_mpower(chartInstance, c1_psi_d);
  c1_wd_y = c1_sb_a * c1_yc_b;
  c1_gf_x = ((c1_sigTxs - c1_qd_y) + c1_td_y) + c1_wd_y;
  c1_hf_x = c1_gf_x;
  c1_if_x = c1_hf_x;
  ...
  c1_ad_b = c1_kf_x;
  c1_xd_y = 21.096972567806741 * c1_ad_b;
  c1_tb_a = c1_xd_y;
  c1_bd_b = c1_phi_dd;
  c1_yd_y = c1_tb_a * c1_bd_b;
  c1_mf_x = c1_phi;
  c1_nf_x = c1_mf_x;
  c1_of_x = c1_nf_x;
  c1_nf_x = c1_of_x;
  ...
  c1_cd_b = c1_nf_x;
  c1_ae_y = 21.096972567806741 * c1_cd_b;
  c1_ub_a = c1_ae_y;
  c1_dd_b = c1_mpower(chartInstance, c1_phi_d);
  c1_be_y = c1_ub_a * c1_dd_b;
  c1_ed_b = c1_a_x;
  c1_ce_y = 680.300883630074 * c1_ed_b;
  c1_pf_x = c1_phi;
  c1_qf_x = c1_pf_x;
  c1_rf_x = c1_qf_x;
  c1_qf_x = c1_rf_x;
  ...
  c1_gd_b = c1_tf_x;
  c1_ee_y = -182.72386552351787 * c1_gd_b;
  c1_vf_x = c1_phi;
  c1_wf_x = c1_vf_x;
  c1_xf_x = c1_wf_x;
  c1_wf_x = c1_xf_x;
  ...
  c1_wb_a = c1_ee_y;
  c1_hd_b = c1_wf_x;
  c1_fe_y = c1_wb_a * c1_hd_b;
  c1_xb_a = c1_fe_y;
  c1_id_b = c1_psi_d;
  c1_ge_y = c1_xb_a * c1_id_b;
  c1_yb_a = c1_ge_y;
  c1_jd_b = c1_phi_d;
  c1_he_y = c1_yb_a * c1_jd_b;
  c1_yf_x = (((c1_sigTz - c1_yd_y) - c1_be_y) - c1_de_y) - c1_he_y;
  c1_ie_y = c1_I_zzo;
  c1_ag_x = c1_yf_x;
  c1_je_y = c1_ie_y;
  c1_bg_x = c1_ag_x;
  c1_ke_y = c1_je_y;
  c1_psi_dd_new = c1_bg_x / c1_ke_y;
  ...
  for (c1_i42 = 0; c1_i42 < 10; c1_i42 = c1_i42 + 1) {
    (*c1_b_pdot)[c1_i42] = c1_pdot[c1_i42];
  }

  for (c1_i43 = 0; c1_i43 < 4; c1_i43 = c1_i43 + 1) {
    (*c1_b_slp_ang)[c1_i43] = c1_slp_ang[c1_i43];
  }

  for (c1_i44 = 0; c1_i44 < 5; c1_i44 = c1_i44 + 1) {
    (*c1_b_acc_out)[c1_i44] = c1_acc_out[c1_i44];
  }

  for (c1_i45 = 0; c1_i45 < 4; c1_i45 = c1_i45 + 1) {
    (*c1_b_Fout)[c1_i45] = c1_Fout[c1_i45];
  }
  ...
  real_T c1_b_C[9])
{
  ...
  for (c1_i50 = 0; c1_i50 < 9; c1_i50 = c1_i50 + 1) {
    c1_c_A[c1_i50] = c1_b_A[c1_i50];
  }

  for (c1_i51 = 0; c1_i51 < 9; c1_i51 = c1_i51 + 1) {
    c1_c_B[c1_i51] = c1_b_B[c1_i51];
  }

  for (c1_i52 = 0; c1_i52 < 3; c1_i52 = c1_i52 + 1) {
    c1_i53 = 0;
    for (c1_i54 = 0; c1_i54 < 3; c1_i54 = c1_i54 + 1) {
      c1_b_C[c1_i53 + c1_i52] = 0.0;
      c1_i55 = 0;
      for (c1_i56 = 0; c1_i56 < 3; c1_i56 = c1_i56 + 1) {
        c1_b_C[c1_i53 + c1_i52] = c1_b_C[c1_i53 + c1_i52] + c1_c_A[c1_i55 +
          c1_i52] * c1_c_B[c1_i56 + c1_i53];
        c1_i55 = c1_i55 + 3;
      }
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Hirtle_originalInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i57 = 0; c1_i57 < 4; c1_i57 = c1_i57 + 1) {
    c1_b_u[c1_i57] = (*((real_T (*)[4])c1_u))[c1_i57];
  }

  for (c1_i58 = 0; c1_i58 < 4; c1_i58 = c1_i58 + 1) {
    c1_c_u[c1_i58] = c1_b_u[c1_i58];
  }
...
static const mxArray *c1_b_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Hirtle_originalInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i59 = 0; c1_i59 < 5; c1_i59 = c1_i59 + 1) {
    c1_b_u[c1_i59] = (*((real_T (*)[5])c1_u))[c1_i59];
  }

  for (c1_i60 = 0; c1_i60 < 5; c1_i60 = c1_i60 + 1) {
    c1_c_u[c1_i60] = c1_b_u[c1_i60];
  }
...
static const mxArray *c1_c_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Hirtle_originalInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i61 = 0; c1_i61 < 10; c1_i61 = c1_i61 + 1) {
    c1_b_u[c1_i61] = (*((real_T (*)[10])c1_u))[c1_i61];
  }

  for (c1_i62 = 0; c1_i62 < 10; c1_i62 = c1_i62 + 1) {
    c1_c_u[c1_i62] = c1_b_u[c1_i62];
  }
...
static const mxArray *c1_d_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  chartInstance = (SFc1_DVM_Hirtle_originalInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  for (c1_i63 = 0; c1_i63 < 5; c1_i63 = c1_i63 + 1) {
    c1_b_u[c1_i63] = (*((real_T (*)[5])c1_u))[c1_i63];
  }

  for (c1_i64 = 0; c1_i64 < 5; c1_i64 = c1_i64 + 1) {
    c1_c_u[c1_i64] = c1_b_u[c1_i64];
  }
...
static const mxArray *c1_f_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  for (c1_i66 = 0; c1_i66 < 3; c1_i66 = c1_i66 + 1) {
    for (c1_i67 = 0; c1_i67 < 3; c1_i67 = c1_i67 + 1) {
      c1_b_u[c1_i67 + c1_i65] = (*((real_T (*)[9])c1_u))[c1_i67 + c1_i65];
    }
  ...
  for (c1_i69 = 0; c1_i69 < 3; c1_i69 = c1_i69 + 1) {
    for (c1_i70 = 0; c1_i70 < 3; c1_i70 = c1_i70 + 1) {
      c1_c_u[c1_i70 + c1_i68] = c1_b_u[c1_i70 + c1_i68];
    }
...
static const mxArray *c1_g_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i71 = 0;
  for (c1_i72 = 0; c1_i72 < 2; c1_i72 = c1_i72 + 1) {
    for (c1_i73 = 0; c1_i73 < 4; c1_i73 = c1_i73 + 1) {
      c1_b_u[c1_i73 + c1_i71] = (*((real_T (*)[8])c1_u))[c1_i73 + c1_i71];
    }
  ...
  c1_i74 = 0;
  for (c1_i75 = 0; c1_i75 < 2; c1_i75 = c1_i75 + 1) {
    for (c1_i76 = 0; c1_i76 < 4; c1_i76 = c1_i76 + 1) {
      c1_c_u[c1_i76 + c1_i74] = c1_b_u[c1_i76 + c1_i74];
    }
...
static const mxArray *c1_h_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  c1_y = NULL;
  c1_i77 = 0;
  for (c1_i78 = 0; c1_i78 < 2; c1_i78 = c1_i78 + 1) {
    for (c1_i79 = 0; c1_i79 < 5; c1_i79 = c1_i79 + 1) {
      c1_b_u[c1_i79 + c1_i77] = (*((real_T (*)[10])c1_u))[c1_i79 + c1_i77];
    }
  ...
  c1_i80 = 0;
  for (c1_i81 = 0; c1_i81 < 2; c1_i81 = c1_i81 + 1) {
    for (c1_i82 = 0; c1_i82 < 5; c1_i82 = c1_i82 + 1) {
      c1_c_u[c1_i82 + c1_i80] = c1_b_u[c1_i82 + c1_i80];
    }
...
const mxArray *sf_c1_DVM_Hirtle_original_get_eml_resolved_functions_info(void)
{
  ...
  for (c1_i83 = 0; c1_i83 < 57; c1_i83 = c1_i83 + 1) {
    ...
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c1_i83
                    );
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c1_i83
                    );
  }
  ...
  c1_name, real_T c1_y[5])
{
  ...
  sf_mex_import(c1_name, sf_mex_dup(c1_acc_out), c1_dv14, 1, 0, 0U, 1, 0U, 2, 1,
                5);
  for (c1_i85 = 0; c1_i85 < 5; c1_i85 = c1_i85 + 1) {
    c1_y[c1_i85] = c1_dv14[c1_i85];
  }
  ...
  c1_name, real_T c1_y[10])
{
  ...
  for (c1_i86 = 0; c1_i86 < 10; c1_i86 = c1_i86 + 1) {
    c1_y[c1_i86] = c1_dv15[c1_i86];
  }
...
static uint8_T c1_d_emlrt_marshallIn(SFc1_DVM_Hirtle_originalInstanceStruct
  *chartInstance, const mxArray *
  c1_b_is_active_c1_DVM_Hirtle_original, const char_T *c1_name)
{
  uint8_T c1_y;
  uint8_T c1_u0;
  sf_mex_import(c1_name, sf_mex_dup(c1_b_is_active_c1_DVM_Hirtle_original),
                &c1_u0, 1, 3, 0U, 0, 0U, 0);
  c1_y = c1_u0;
  sf_mex_destroy(&c1_b_is_active_c1_DVM_Hirtle_original);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_DVM_Hirtle_original_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(442045524U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1191534450U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2108078261U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3367689077U);
}

mxArray *sf_c1_DVM_Hirtle_original_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(1326579178U);
    pr[1] = (double)(1173746840U);
    pr[2] = (double)(2773741539U);
    pr[3] = (double)(1000255683U);
...
static mxArray *sf_get_sim_state_info_c1_DVM_Hirtle_original(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[11],T\"Fout\",},{M[1],M[10],T\"acc_out\",},{M[1],M[5],T\"pdot\",},{M[1],M[9],T\"slp_ang\",},{M[8],M[0],T\"is_active_c1_DVM_Hirtle_original\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DVM_Hirtle_original_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance;
    chartInstance = (SFc1_DVM_Hirtle_originalInstanceStruct *) ((ChartInfoStruct
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_DVM_Hirtle_originalMachineNumber_,
           1,
           1,
           1,
           8,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_DVM_Hirtle_originalMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_DVM_Hirtle_originalMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_DVM_Hirtle_originalMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,9059);
      ...
      sf_debug_reset_current_state_configuration
        (_DVM_Hirtle_originalMachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_DVM_Hirtle_original(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DVM_Hirtle_originalInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_DVM_Hirtle_original
    ((SFc1_DVM_Hirtle_originalInstanceStruct*) chartInstanceVar);
  initialize_c1_DVM_Hirtle_original((SFc1_DVM_Hirtle_originalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_DVM_Hirtle_original(void *chartInstanceVar)
{
  enable_c1_DVM_Hirtle_original((SFc1_DVM_Hirtle_originalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_DVM_Hirtle_original(void *chartInstanceVar)
{
  disable_c1_DVM_Hirtle_original((SFc1_DVM_Hirtle_originalInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_DVM_Hirtle_original(void *chartInstanceVar)
{
  sf_c1_DVM_Hirtle_original((SFc1_DVM_Hirtle_originalInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c1_DVM_Hirtle_original(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DVM_Hirtle_original
    ((SFc1_DVM_Hirtle_originalInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c1_DVM_Hirtle_original();/* state var info */
...
static void sf_internal_set_sim_state_c1_DVM_Hirtle_original(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DVM_Hirtle_original();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c1_DVM_Hirtle_original((SFc1_DVM_Hirtle_originalInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c1_DVM_Hirtle_original(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DVM_Hirtle_original(S);
}

static void sf_opaque_set_sim_state_c1_DVM_Hirtle_original(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_DVM_Hirtle_original(S, st);
}

static void sf_opaque_terminate_c1_DVM_Hirtle_original(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DVM_Hirtle_originalInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_DVM_Hirtle_original((SFc1_DVM_Hirtle_originalInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c1_DVM_Hirtle_original
    ((SFc1_DVM_Hirtle_originalInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DVM_Hirtle_original(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_DVM_Hirtle_original
      ((SFc1_DVM_Hirtle_originalInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DVM_Hirtle_original(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"DVM_Hirtle_original","DVM_Hirtle_original",
      1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"DVM_Hirtle_original",
                "DVM_Hirtle_original",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"DVM_Hirtle_original",
      "DVM_Hirtle_original",1,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"DVM_Hirtle_original",
        "DVM_Hirtle_original",1,4);
      sf_mark_chart_reusable_outputs(S,"DVM_Hirtle_original",
        "DVM_Hirtle_original",1,4);
    }

    sf_set_rtw_dwork_info(S,"DVM_Hirtle_original","DVM_Hirtle_original",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(1528466812U));
  ssSetChecksum1(S,(854893477U));
  ssSetChecksum2(S,(2167883052U));
  ssSetChecksum3(S,(4089999978U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_DVM_Hirtle_original(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "DVM_Hirtle_original", "DVM_Hirtle_original",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_DVM_Hirtle_original(SimStruct *S)
{
  SFc1_DVM_Hirtle_originalInstanceStruct *chartInstance;
  chartInstance = (SFc1_DVM_Hirtle_originalInstanceStruct *)malloc(sizeof
    (SFc1_DVM_Hirtle_originalInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DVM_Hirtle_originalInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DVM_Hirtle_original;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DVM_Hirtle_original;
...
void c1_DVM_Hirtle_original_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DVM_Hirtle_original(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DVM_Hirtle_original(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DVM_Hirtle_original(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DVM_Hirtle_original_method_dispatcher.\n"
